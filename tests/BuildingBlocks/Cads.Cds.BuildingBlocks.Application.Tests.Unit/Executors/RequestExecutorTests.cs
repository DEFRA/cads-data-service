...
namespace Cads.Cds.BuildingBlocks.Application.Tests.Unit.Executors;
...
public class RequestExecutorTests
{
    ...
    public async Task ExecuteCommand_ShouldSendCommandViaMediator()
    {
        ...
        var result = await executor.ExecuteCommand(command, TestContext.Current.CancellationToken);
    ...
    public async Task ExecuteQuery_ShouldSendQueryViaMediator()
    {
        ...
        var result = await executor.ExecuteQuery(query, TestContext.Current.CancellationToken);
    ...
    public async Task ExecuteTrackedCommand_ShouldReturnFullTrackedResult()
    {
        ...
        var result = await executor.ExecuteTrackedCommand(command, TestContext.Current.CancellationToken);
