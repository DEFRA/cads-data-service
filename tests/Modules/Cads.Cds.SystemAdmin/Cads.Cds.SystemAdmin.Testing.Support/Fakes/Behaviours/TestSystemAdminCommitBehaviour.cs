...
namespace Cads.Cds.SystemAdmin.Testing.Support.Fakes.Behaviours;

public class TestSystemAdminCommitBehaviour<TRequest, TResponse>(SystemAdminWriteDbContext dbContext)
