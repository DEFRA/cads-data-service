...
namespace Cads.Cds.MiBff.Tests.Component.UkvEndpoints.JourneyHauliers;

public class UkvJourneysHauliersEndpointTests(MiBffTestFixture testFixture) : IClassFixture<MiBffTestFixture>
{
    private readonly MiBffTestFixture _testFixture = testFixture;

    [Fact]
    public async Task GetJourneysHauliers_Endpoint_Uses_Defaults_And_Returns_Ok()
    {
        // Arrange
        var endpoint = TestEndpointConstants.BffUkvJourneysHauliersEndpoint;
