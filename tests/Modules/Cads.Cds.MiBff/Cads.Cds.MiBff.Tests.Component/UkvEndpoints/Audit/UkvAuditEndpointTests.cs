...
namespace Cads.Cds.MiBff.Tests.Component.UkvEndpoints.Audit;

public class UkvAudiEndpointTests(MiBffTestFixture testFixture) : IClassFixture<MiBffTestFixture>
{
    private readonly MiBffTestFixture _testFixture = testFixture;

    [Fact]
    public async Task GetAudit_Endpoint_Uses_Defaults_And_Returns_Ok()
    {
        // Arrange
        var endpoint = TestEndpointConstants.BffUkvAuditsScrapieEndpoint;
