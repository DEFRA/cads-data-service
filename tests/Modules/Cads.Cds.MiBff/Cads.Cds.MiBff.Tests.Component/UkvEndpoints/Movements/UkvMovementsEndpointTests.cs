...
namespace Cads.Cds.MiBff.Tests.Component.UkvEndpoints.Movements;

public class UkvMovementsEndpointTests(MiBffTestFixture testFixture) : IClassFixture<MiBffTestFixture>
{
    private readonly MiBffTestFixture _testFixture = testFixture;

    [Fact]
    public async Task GetMovements_Endpoint_Uses_Defaults_And_Returns_Ok()
    {
        // Arrange
        var endpoint = TestEndpointConstants.BffUkvMovementsEndpoint;
