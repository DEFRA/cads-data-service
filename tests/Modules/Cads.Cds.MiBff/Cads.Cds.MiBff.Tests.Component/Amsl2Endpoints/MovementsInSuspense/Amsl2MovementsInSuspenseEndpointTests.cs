...
namespace Cads.Cds.MiBff.Tests.Component.Amsl2Endpoints.MovementsInSuspense;

public class Amsl2MovementsInSuspenseEndpointTests(MiBffTestFixture testFixture) : IClassFixture<MiBffTestFixture>
{
