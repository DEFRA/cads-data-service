...
namespace Cads.Cds.MiBff.Tests.Component.Amsl2Endpoints.AnimalSummary;

public class Amsl2AnimalSummaryEndpointTests(MiBffTestFixture testFixture) : IClassFixture<MiBffTestFixture>
{
    private readonly MiBffTestFixture _testFixture = testFixture;

    [Fact]
    public async Task GetAnimalSummaryByAnimalId_Endpoint_Passes_AnimalId_And_Returns_Ok()
    {
        // Arrange
        var animalId = "e6f2cb0f-6702-4060-951f-b32e018b3b92";
        var endpoint = string.Format(TestEndpointConstants.BffAmsl2AnimalSummaryEndpoint, animalId);
