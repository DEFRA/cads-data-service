...
public class GetHoldingSummaryReportTests(MiBffTestFixture testFixture) : IClassFixture<MiBffTestFixture>
{
    ...
    public async Task GivenValidRequest_GetHoldingSummaryReport_ShouldSucceed()
    {
        ...
        var request = new GetPlaceholderReportRequest { ReportKey = "holding_summary" };
