...
public class GetJourneyByHaulierReportTests(MiBffTestFixture testFixture) : IClassFixture<MiBffTestFixture>
{
    private readonly MiBffTestFixture _testFixture = testFixture;

    [Fact]
    public async Task GivenValidRequest_GetJourneyByHaulierReport_ShouldSucceed()
    {
        var endpoint = "/api/v1/bff/mi/reports/journey_by_haulier";

        var request = new GetPlaceholderReportRequest { ReportKey = "journey_by_haulier" };
