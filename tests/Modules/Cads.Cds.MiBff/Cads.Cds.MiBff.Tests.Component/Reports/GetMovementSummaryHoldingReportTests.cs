...
public class GetMovementSummaryHoldingReportTests(MiBffTestFixture testFixture) : IClassFixture<MiBffTestFixture>
{
    private readonly MiBffTestFixture _testFixture = testFixture;

    [Fact]
    public async Task GivenValidRequest_GetMovementSummaryHoldingReport_ShouldSucceed()
    {
        var endpoint = "/api/v1/bff/mi/reports/movement_summary_holding";

        var request = new GetPlaceholderReportRequest { ReportKey = "movement_summary_holding" };
