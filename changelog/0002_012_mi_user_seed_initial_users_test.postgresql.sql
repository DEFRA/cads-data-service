...
--changeset mark:seed-mark-gent-role context:test
...
--changeset mark:seed-gary-fletcher context:test
INSERT INTO cads.mi_user (user_id, external_subject, display_name, email, is_active)
VALUES (gen_random_uuid(), '${gfEmail}', '${gfName}', '${gfEmail}', true);

--changeset mark:seed-gary-fletcher-role context:test
INSERT INTO cads.mi_user_role (user_id, role_id)
SELECT u.user_id, r.role_id
FROM cads.mi_user u
JOIN cads.mi_role r ON r.role_key = 'MI_ADMIN'
...
--changeset mark:seed-craig-john context:test
INSERT INTO cads.mi_user (user_id, external_subject, display_name, email, is_active)
VALUES (gen_random_uuid(), '${cjEmail}', '${cjName}', '${cjEmail}', true);

--changeset mark:seed-craig-john-role context:test
INSERT INTO cads.mi_user_role (user_id, role_id)
SELECT u.user_id, r.role_id
FROM cads.mi_user u
JOIN cads.mi_role r ON r.role_key = 'MI_ADMIN'
...
--changeset mark:seed-david-baillie context:test
INSERT INTO cads.mi_user (user_id, external_subject, display_name, email, is_active)
VALUES (gen_random_uuid(), '${dbEmail}', '${dbName}', '${dbEmail}', true);

--changeset mark:seed-david-baillie-role context:test
INSERT INTO cads.mi_user_role (user_id, role_id)
SELECT u.user_id, r.role_id
FROM cads.mi_user u
JOIN cads.mi_role r ON r.role_key = 'MI_ADMIN'
...
--changeset mark:seed-andy-rose context:test
INSERT INTO cads.mi_user (user_id, external_subject, display_name, email, is_active)
VALUES (gen_random_uuid(), '${arEmail}', '${arName}', '${arEmail}', true);

--changeset mark:seed-andy-rose-role context:test
INSERT INTO cads.mi_user_role (user_id, role_id)
SELECT u.user_id, r.role_id
FROM cads.mi_user u
JOIN cads.mi_role r ON r.role_key = 'MI_ADMIN'
...
--changeset mark:seed-tom-harrison context:test
INSERT INTO cads.mi_user (user_id, external_subject, display_name, email, is_active)
VALUES (gen_random_uuid(), '${thEmail}', '${thName}', '${thEmail}', true);

--changeset mark:seed-tom-harrison-role context:test
INSERT INTO cads.mi_user_role (user_id, role_id)
SELECT u.user_id, r.role_id
FROM cads.mi_user u
JOIN cads.mi_role r ON r.role_key = 'MI_ADMIN'
