...
(
    ...
    adr_aud_id bigint,
    adr_aud_type text,
    adr_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
...
(
    ...
    ach_aud_id bigint,
    ach_aud_type text,
    ach_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    anc_aud_id bigint,
    anc_aud_type text,
    anc_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    ase_aud_id bigint,
    ase_aud_type text,
    ase_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    acs_aud_id bigint,
    acs_aud_type text,
    acs_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    aid_aud_id bigint,
    aid_aud_type text,
    aid_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    aar_aud_id bigint,
    aar_aud_type text,
    aar_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    ast_aud_id bigint,
    ast_aud_type text,
    ast_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    aps_aud_id bigint,
    aps_aud_type text,
    aps_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    ald_aud_id bigint,
    ald_aud_type text,
    ald_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    cle_aud_id bigint,
    cle_aud_type text,
    cle_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    cld_aud_id bigint,
    cld_aud_type text,
    cld_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    cmr_aud_id bigint,
    cmr_aud_type text,
    cmr_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    coa_aud_id bigint,
    coa_aud_type text,
    coa_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    cme_aud_id bigint,
    cme_aud_type text,
    cme_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    com_aud_id bigint,
    com_aud_type text,
    com_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    kns_aud_id bigint,
    kns_aud_type text,
    kns_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    cus_aud_id bigint,
    cus_aud_type text,
    cus_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    est_aud_id bigint,
    est_aud_type text,
    est_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    etg_aud_id bigint,
    etg_aud_type text,
    etg_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    eid_aud_id bigint,
    eid_aud_type text,
    eid_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    eml_aud_id bigint,
    eml_aud_type text,
    eml_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    ere_aud_id bigint,
    ere_aud_type text,
    ere_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    erm_aud_id bigint,
    erm_aud_type text,
    erm_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    erl_aud_id bigint,
    erl_aud_type text,
    erl_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    erq_aud_id bigint,
    erq_aud_type text,
    erq_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    cet_aud_id bigint,
    cet_aud_type text,
    cet_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    iul_aud_id bigint,
    iul_aud_type text,
    iul_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    ido_aud_id bigint,
    ido_aud_type text,
    ido_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    lar_aud_id bigint,
    lar_aud_type text,
    lar_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    las_aud_id bigint,
    las_aud_type text,
    las_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    let_aud_id bigint,
    let_aud_type text,
    let_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    lid_aud_id bigint,
    lid_aud_type text,
    lid_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    lpr_aud_id bigint,
    lpr_aud_type text,
    lpr_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    llr_aud_id bigint,
    llr_aud_type text,
    llr_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    loc_aud_id bigint,
    loc_aud_type text,
    loc_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    lra_aud_id bigint,
    lra_aud_type text,
    lra_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    mce_aud_id bigint,
    mce_aud_type text,
    mce_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    cph_aud_id bigint,
    cph_aud_type text,
    cph_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    hst_aud_id bigint,
    hst_aud_type text,
    hst_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    mse_aud_id bigint,
    mse_aud_type text,
    mse_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    mcs_aud_id bigint,
    mcs_aud_type text,
    mcs_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    par_aud_id bigint,
    par_aud_type text,
    par_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    ppg_aud_id bigint,
    ppg_aud_type text,
    ppg_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    paf_aud_id bigint,
    paf_aud_type text,
    paf_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    ran_aud_id bigint,
    ran_aud_type text,
    ran_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    rae_aud_id bigint,
    rae_aud_type text,
    rae_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    rme_aud_id bigint,
    rme_aud_type text,
    rme_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    rap_aud_id bigint,
    rap_aud_type text,
    rap_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    rmo_aud_id bigint,
    rmo_aud_type text,
    rmo_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    mov_aud_id bigint,
    mov_aud_type text,
    mov_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    rte_aud_id bigint,
    rte_aud_type text,
    rte_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    sxt_aud_id bigint,
    sxt_aud_type text,
    sxt_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    stf_aud_id bigint,
    stf_aud_type text,
    stf_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    stl_aud_id bigint,
    stl_aud_type text,
    stl_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    stm_aud_id bigint,
    stm_aud_type text,
    stm_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    sae_aud_id bigint,
    sae_aud_type text,
    sae_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    smr_aud_id bigint,
    smr_aud_type text,
    smr_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    scm_aud_id bigint,
    scm_aud_type text,
    scm_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    sme_aud_id bigint,
    sme_aud_type text,
    sme_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    san_aud_id bigint,
    san_aud_type text,
    san_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    smo_aud_id bigint,
    smo_aud_type text,
    smo_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    vap_aud_id bigint,
    vap_aud_type text,
    vap_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    wur_aud_id bigint,
    wur_aud_type text,
    wur_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    wga_aud_id bigint,
    wga_aud_type text,
    wga_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    wsa_aud_id bigint,
    wsa_aud_type text,
    wsa_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    wua_aud_id bigint,
    wua_aud_type text,
    wua_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    wgp_aud_id bigint,
    wgp_aud_type text,
    wgp_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    rou_aud_id bigint,
    rou_aud_type text,
    rou_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    brt_aud_id bigint,
    brt_aud_type text,
    brt_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    brd_aud_id bigint,
    brd_aud_type text,
    brd_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    cls_aud_id bigint,
    cls_aud_type text,
    cls_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    clt_aud_id bigint,
    clt_aud_type text,
    clt_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    cma_aud_id bigint,
    cma_aud_type text,
    cma_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    cvg_aud_id bigint,
    cvg_aud_type text,
    cvg_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    cac_aud_id bigint,
    cac_aud_type text,
    cac_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    cot_aud_id bigint,
    cot_aud_type text,
    cot_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    cov_aud_id bigint,
    cov_aud_type text,
    cov_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    con_aud_id bigint,
    con_aud_type text,
    con_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    cty_aud_id bigint,
    cty_aud_type text,
    cty_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    cry_aud_id bigint,
    cry_aud_type text,
    cry_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    bjk_aud_id bigint,
    bjk_aud_type text,
    bjk_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    etf_aud_id bigint,
    etf_aud_type text,
    etf_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    erf_aud_id bigint,
    erf_aud_type text,
    erf_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    etr_aud_id bigint,
    etr_aud_type text,
    etr_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    ett_aud_id bigint,
    ett_aud_type text,
    ett_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    nid_aud_id bigint,
    nid_aud_type text,
    nid_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    sph_aud_id bigint,
    sph_aud_type text,
    sph_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    flt_aud_id bigint,
    flt_aud_type text,
    flt_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    hss_aud_id bigint,
    hss_aud_type text,
    hss_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    isa_aud_id bigint,
    isa_aud_type text,
    isa_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    lda_aud_id bigint,
    lda_aud_type text,
    lda_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    lrc_aud_id bigint,
    lrc_aud_type text,
    lrc_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    lif_aud_id bigint,
    lif_aud_type text,
    lif_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    lpt_aud_id bigint,
    lpt_aud_type text,
    lpt_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    lrt_aud_id bigint,
    lrt_aud_type text,
    lrt_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    lty_aud_id bigint,
    lty_aud_type text,
    lty_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    war_aud_id bigint,
    war_aud_type text,
    war_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    msg_aud_id bigint,
    msg_aud_type text,
    msg_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    nwd_aud_id bigint,
    nwd_aud_type text,
    nwd_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    pgp_aud_id bigint,
    pgp_aud_type text,
    pgp_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    phd_aud_id bigint,
    phd_aud_type text,
    phd_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    pvl_aud_id bigint,
    pvl_aud_type text,
    pvl_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    pvg_aud_id bigint,
    pvg_aud_type text,
    pvg_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    pch_aud_id bigint,
    pch_aud_type text,
    pch_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    sch_aud_id bigint,
    sch_aud_type text,
    sch_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    slt_aud_id bigint,
    slt_aud_type text,
    slt_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    sca_aud_id bigint,
    sca_aud_type text,
    sca_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
...
(
    ...
    swa_aud_id bigint,
    swa_aud_type text,
    swa_aud_datetime timestamp with time zone DEFAULT clock_timestamp(),
    record_type character varying(1),
    record_count numeric,
    imported_date timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    cts_file_import_id bigint,
