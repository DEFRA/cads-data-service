...
INSERT INTO cads.cts_file_imports(
	...
	VALUES 
		...
		('dtn', 'CTSM_CADS_PROD_BULK_ABC_0006_CT_PARTIES_2026-01-01-012345', 100, NOW(), 1, 1, 0, NULL, NULL),
		('dtn', 'CTSM_CADS_PROD_BULK_ABC_0007_CT_PARTIES_2026-01-01-012345', 100, NOW(), 2, 1, 0, NOW(), NULL),
		('dtn', 'CTSM_CADS_PROD_BULK_ABC_0008_CT_PARTIES_2026-01-01-012345', 100, NOW(), 2, 1, 0, NOW(), NULL),
		('dtn', 'CTSM_CADS_PROD_BULK_ABC_0009_CT_PARTIES_2026-01-01-012345', 100, NOW(), 4, 1, 0, NOW(), NOW())
