...
-- changeset schema:0001-000-cts splitStatements:false
...
create table if not exists _ct_cla_extract
(
...
create table if not exists _ct_cla_mini_detail
(
    cld_id                    numeric(12) not null
        primary key,
    cld_cle_id                numeric(12)
...
create table if not exists _ct_cla_mini_extract
(
    cle_id                    numeric(12) not null
        primary key,
    cle_batch_id              numeric(12),
...
alter table _ct_countries
    add constraint fk_ct_countries_cry_cry_id_main_eu
        foreign key (cry_cry_id_main_eu) references _ct_countries;
...
alter table _ct_animal_identifiers
    add constraint fk_ct_animal_identifiers_aid_aid_id_original
        foreign key (aid_aid_id_original) references _ct_animal_identifiers;

alter table _ct_animal_identifiers
    add constraint fk_ct_animal_identifiers_aid_aid_id_previous
        foreign key (aid_aid_id_previous) references _ct_animal_identifiers;
...
alter table _ct_registered_movements
    add constraint fk_ct_registered_movements_mov_ran_id
        foreign key (mov_ran_id) references _ct_registered_animals;
...
create table if not exists _ct_parties_faker
(
    par_surname       text,
    par_initials      text,
    par_title         text,
...
create table if not exists _ct_locations_faker
(
    loc_tel_number       text,
