...
-- changeset schema:0001-003-cts-audit splitStatements:false

create table if not exists cts_audit.ct_addresses
(
    ...
    audited_at timestamp with time zone DEFAULT clock_timestamp() NOT NULL,
    ...
    row_number numeric,
    trans_id bigint,
    CONSTRAINT ct_addresses_audit_action_check CHECK ((audit_action = ANY (ARRAY['UPDATE'::text, 'DELETE'::text]))),
    CONSTRAINT ct_addresses_pkey PRIMARY KEY (audit_id),
    CONSTRAINT ct_addresses_audit_trans_id_fkey FOREIGN KEY (audit_trans_id) REFERENCES cts_transactions.ct_addresses(trans_id)
);

create table if not exists cts_audit.ct_animal_changes
(
    audit_id bigint GENERATED ALWAYS AS IDENTITY (
        START WITH 1
        INCREMENT BY 1
    ...
    row_number numeric,
    trans_id bigint,
    CONSTRAINT ct_animal_changes_audit_action_check CHECK ((audit_action = ANY (ARRAY['UPDATE'::text, 'DELETE'::text]))),
    CONSTRAINT ct_animal_changes_pkey PRIMARY KEY (audit_id),
    CONSTRAINT ct_animal_changes_audit_trans_id_fkey FOREIGN KEY (audit_trans_id) REFERENCES cts_transactions.ct_animal_changes(trans_id)
);

create table if not exists cts_audit.ct_animal_claims
(
    audit_id bigint GENERATED ALWAYS AS IDENTITY (
        START WITH 1
        INCREMENT BY 1
    ...
    row_number numeric,
    trans_id bigint,
    CONSTRAINT ct_animal_claims_audit_action_check CHECK ((audit_action = ANY (ARRAY['UPDATE'::text, 'DELETE'::text]))),
    CONSTRAINT ct_animal_claims_pkey PRIMARY KEY (audit_id),
    CONSTRAINT ct_animal_claims_audit_trans_id_fkey FOREIGN KEY (audit_trans_id) REFERENCES cts_transactions.ct_animal_claims(trans_id)
);

create table if not exists cts_audit.ct_animal_corr_summ_errors
(
    audit_id bigint GENERATED ALWAYS AS IDENTITY (
        START WITH 1
        INCREMENT BY 1
    ...
    row_number numeric,
    trans_id bigint,
    CONSTRAINT ct_animal_corr_summ_errors_audit_action_check CHECK ((audit_action = ANY (ARRAY['UPDATE'::text, 'DELETE'::text]))),
    CONSTRAINT ct_animal_corr_summ_errors_pkey PRIMARY KEY (audit_id),
    CONSTRAINT ct_animal_corr_summ_errors_audit_trans_id_fkey FOREIGN KEY (audit_trans_id) REFERENCES cts_transactions.ct_animal_corr_summ_errors(trans_id)
);

create table if not exists cts_audit.ct_animal_correct_summaries
(
    audit_id bigint GENERATED ALWAYS AS IDENTITY (
        START WITH 1
        INCREMENT BY 1
    ...
    row_number numeric,
    trans_id bigint,
    CONSTRAINT ct_animal_correct_summaries_audit_action_check CHECK ((audit_action = ANY (ARRAY['UPDATE'::text, 'DELETE'::text]))),
    CONSTRAINT ct_animal_correct_summaries_pkey PRIMARY KEY (audit_id),
    CONSTRAINT ct_animal_correct_summaries_audit_trans_id_fkey FOREIGN KEY (audit_trans_id) REFERENCES cts_transactions.ct_animal_correct_summaries(trans_id)
);

create table if not exists cts_audit.ct_animal_identifiers
(
    audit_id bigint GENERATED ALWAYS AS IDENTITY (
        START WITH 1
        INCREMENT BY 1
    ...
    row_number numeric,
    trans_id bigint,
    CONSTRAINT ct_animal_identifiers_audit_action_check CHECK ((audit_action = ANY (ARRAY['UPDATE'::text, 'DELETE'::text]))),
    CONSTRAINT ct_animal_identifiers_pkey PRIMARY KEY (audit_id),
    CONSTRAINT ct_animal_identifiers_audit_trans_id_fkey FOREIGN KEY (audit_trans_id) REFERENCES cts_transactions.ct_animal_identifiers(trans_id)
);

create table if not exists cts_audit.ct_animal_relationships
(
    audit_id bigint GENERATED ALWAYS AS IDENTITY (
        START WITH 1
        INCREMENT BY 1
    ...
    audit_trans_id bigint,
    trans_id bigint,
    CONSTRAINT ct_animal_relationships_audit_action_check CHECK ((audit_action = ANY (ARRAY['UPDATE'::text, 'DELETE'::text]))),
    CONSTRAINT ct_animal_relationships_pkey PRIMARY KEY (audit_id),
    CONSTRAINT ct_animal_relationships_audit_trans_id_fkey FOREIGN KEY (audit_trans_id) REFERENCES cts_transactions.ct_animal_relationships(trans_id)
);

create table if not exists cts_audit.ct_animal_statuses
(
    audit_id bigint GENERATED ALWAYS AS IDENTITY (
        START WITH 1
        INCREMENT BY 1
    ...
    audit_trans_id bigint,
    trans_id bigint,
    CONSTRAINT ct_animal_statuses_audit_action_check CHECK ((audit_action = ANY (ARRAY['UPDATE'::text, 'DELETE'::text]))),
    CONSTRAINT ct_animal_statuses_pkey PRIMARY KEY (audit_id),
    CONSTRAINT ct_animal_statuses_audit_trans_id_fkey FOREIGN KEY (audit_trans_id) REFERENCES cts_transactions.ct_animal_statuses(trans_id)
);

create table if not exists cts_audit.ct_applic_statuses
(
    audit_id bigint GENERATED ALWAYS AS IDENTITY (
        START WITH 1
        INCREMENT BY 1
    ...
    row_number numeric,
    trans_id bigint,
    CONSTRAINT ct_applic_statuses_audit_action_check CHECK ((audit_action = ANY (ARRAY['UPDATE'::text, 'DELETE'::text]))),
    CONSTRAINT ct_applic_statuses_pkey PRIMARY KEY (audit_id),
    CONSTRAINT ct_applic_statuses_audit_trans_id_fkey FOREIGN KEY (audit_trans_id) REFERENCES cts_transactions.ct_applic_statuses(trans_id)
);

create table if not exists cts_audit.ct_application_late_days
(
    audit_id bigint GENERATED ALWAYS AS IDENTITY (
        START WITH 1
        INCREMENT BY 1
    ...
    row_number numeric,
    trans_id bigint,
    CONSTRAINT ct_application_late_days_audit_action_check CHECK ((audit_action = ANY (ARRAY['UPDATE'::text, 'DELETE'::text]))),
    CONSTRAINT ct_application_late_days_pkey PRIMARY KEY (audit_id),
    CONSTRAINT ct_application_late_days_audit_trans_id_fkey FOREIGN KEY (audit_trans_id) REFERENCES cts_transactions.ct_application_late_days(trans_id)
);

create table if not exists cts_audit.ct_cla_extract
(
    audit_id bigint GENERATED ALWAYS AS IDENTITY (
        START WITH 1
        INCREMENT BY 1
    ...
    row_number numeric,
    trans_id bigint,
    CONSTRAINT ct_cla_extract_audit_action_check CHECK ((audit_action = ANY (ARRAY['UPDATE'::text, 'DELETE'::text]))),
    CONSTRAINT ct_cla_extract_pkey PRIMARY KEY (audit_id),
    CONSTRAINT ct_cla_extract_audit_trans_id_fkey FOREIGN KEY (audit_trans_id) REFERENCES cts_transactions.ct_cla_extract(trans_id)
);

create table if not exists cts_audit.ct_cla_extract_detail
(
    audit_id bigint GENERATED ALWAYS AS IDENTITY (
        START WITH 1
        INCREMENT BY 1
    ...
    trans_id bigint,
    CONSTRAINT ct_cla_extract_detail_audit_action_check CHECK ((audit_action = ANY (ARRAY['UPDATE'::text, 'DELETE'::text]))),
    CONSTRAINT ct_cla_extract_detail_pkey PRIMARY KEY (audit_id),
    CONSTRAINT ct_cla_extract_detail_audit_trans_id_fkey FOREIGN KEY (audit_trans_id) REFERENCES cts_transactions.ct_cla_extract_detail(trans_id)
);

create table if not exists cts_audit.ct_cla_extract_dm
(
    audit_id bigint GENERATED ALWAYS AS IDENTITY (
        START WITH 1
        INCREMENT BY 1
    ...
    row_number numeric,
    trans_id bigint,
    CONSTRAINT ct_cla_extract_dm_audit_action_check CHECK ((audit_action = ANY (ARRAY['UPDATE'::text, 'DELETE'::text]))),
    CONSTRAINT ct_cla_extract_dm_pkey PRIMARY KEY (audit_id),
    CONSTRAINT ct_cla_extract_dm_audit_trans_id_fkey FOREIGN KEY (audit_trans_id) REFERENCES cts_transactions.ct_cla_extract_dm(trans_id)
);

create table if not exists cts_audit.ct_cla_mini_detail
(
    audit_id bigint GENERATED ALWAYS AS IDENTITY (
        START WITH 1
        INCREMENT BY 1
    ...
    cld_current_modified_date date,
    trans_id bigint,
    CONSTRAINT ct_cla_mini_detail_audit_action_check CHECK ((audit_action = ANY (ARRAY['UPDATE'::text, 'DELETE'::text]))),
    CONSTRAINT ct_cla_mini_detail_pkey PRIMARY KEY (audit_id),
    CONSTRAINT ct_cla_mini_detail_audit_trans_id_fkey FOREIGN KEY (audit_trans_id) REFERENCES cts_transactions.ct_cla_mini_detail(trans_id)
);

create table if not exists cts_audit.ct_cla_mini_extract
(
    audit_id bigint GENERATED ALWAYS AS IDENTITY (
        START WITH 1
        INCREMENT BY 1
    ...
    row_number numeric,
    trans_id bigint,
    CONSTRAINT ct_cla_mini_extract_audit_action_check CHECK ((audit_action = ANY (ARRAY['UPDATE'::text, 'DELETE'::text]))),
    CONSTRAINT ct_cla_mini_extract_pkey PRIMARY KEY (audit_id),
    CONSTRAINT ct_cla_mini_extract_audit_trans_id_fkey FOREIGN KEY (audit_trans_id) REFERENCES cts_transactions.ct_cla_mini_extract(trans_id)
);

create table if not exists cts_audit.ct_cm_measures_results
(
    audit_id bigint GENERATED ALWAYS AS IDENTITY (
        START WITH 1
        INCREMENT BY 1
    ...
    audit_trans_id bigint,
    trans_id bigint,
    CONSTRAINT ct_cm_measures_results_audit_action_check CHECK ((audit_action = ANY (ARRAY['UPDATE'::text, 'DELETE'::text]))),
    CONSTRAINT ct_cm_measures_results_pkey PRIMARY KEY (audit_id),
    CONSTRAINT ct_cm_measures_results_audit_trans_id_fkey FOREIGN KEY (audit_trans_id) REFERENCES cts_transactions.ct_cm_measures_results(trans_id)
);

create table if not exists cts_audit.ct_comms_addresses
(
    audit_id bigint GENERATED ALWAYS AS IDENTITY (
        START WITH 1
        INCREMENT BY 1
    ...
    row_number numeric,
    trans_id bigint,
    CONSTRAINT ct_comms_addresses_audit_action_check CHECK ((audit_action = ANY (ARRAY['UPDATE'::text, 'DELETE'::text]))),
    CONSTRAINT ct_comms_addresses_pkey PRIMARY KEY (audit_id),
    CONSTRAINT ct_comms_addresses_audit_trans_id_fkey FOREIGN KEY (audit_trans_id) REFERENCES cts_transactions.ct_comms_addresses(trans_id)
);

create table if not exists cts_audit.ct_condition_marker_errors
(
    audit_id bigint GENERATED ALWAYS AS IDENTITY (
        START WITH 1
        INCREMENT BY 1
    ...
    row_number numeric,
    trans_id bigint,
    CONSTRAINT ct_condition_marker_errors_audit_action_check CHECK ((audit_action = ANY (ARRAY['UPDATE'::text, 'DELETE'::text]))),
    CONSTRAINT ct_condition_marker_errors_pkey PRIMARY KEY (audit_id),
    CONSTRAINT ct_condition_marker_errors_audit_trans_id_fkey FOREIGN KEY (audit_trans_id) REFERENCES cts_transactions.ct_condition_marker_errors(trans_id)
);

create table if not exists cts_audit.ct_condition_markers
(
    audit_id bigint GENERATED ALWAYS AS IDENTITY (
        START WITH 1
        INCREMENT BY 1
    ...
    audit_trans_id bigint,
    trans_id bigint,
    CONSTRAINT ct_condition_markers_audit_action_check CHECK ((audit_action = ANY (ARRAY['UPDATE'::text, 'DELETE'::text]))),
    CONSTRAINT ct_condition_markers_pkey PRIMARY KEY (audit_id),
    CONSTRAINT ct_condition_markers_audit_trans_id_fkey FOREIGN KEY (audit_trans_id) REFERENCES cts_transactions.ct_condition_markers(trans_id)
);

create table if not exists cts_audit.ct_cps167_report
(
    audit_id bigint GENERATED ALWAYS AS IDENTITY (
        START WITH 1
        INCREMENT BY 1
    ...
    row_number numeric,
    trans_id bigint,
    CONSTRAINT ct_cps167_report_audit_action_check CHECK ((audit_action = ANY (ARRAY['UPDATE'::text, 'DELETE'::text]))),
    CONSTRAINT ct_cps167_report_pkey PRIMARY KEY (audit_id),
    CONSTRAINT ct_cps167_report_audit_trans_id_fkey FOREIGN KEY (audit_trans_id) REFERENCES cts_transactions.ct_cps167_report(trans_id)
);

create table if not exists cts_audit.ct_cts_users
(
    audit_id bigint GENERATED ALWAYS AS IDENTITY (
        START WITH 1
        INCREMENT BY 1
    ...
    row_number numeric,
    trans_id bigint,
    CONSTRAINT ct_cts_users_audit_action_check CHECK ((audit_action = ANY (ARRAY['UPDATE'::text, 'DELETE'::text]))),
    CONSTRAINT ct_cts_users_pkey PRIMARY KEY (audit_id),
    CONSTRAINT ct_cts_users_audit_trans_id_fkey FOREIGN KEY (audit_trans_id) REFERENCES cts_transactions.ct_cts_users(trans_id)
);

create table if not exists cts_audit.ct_eartag_staging
(
    audit_id bigint GENERATED ALWAYS AS IDENTITY (
        START WITH 1
        INCREMENT BY 1
    ...
    trans_id bigint,
    CONSTRAINT ct_eartag_staging_audit_action_check CHECK ((audit_action = ANY (ARRAY['UPDATE'::text, 'DELETE'::text]))),
    CONSTRAINT ct_eartag_staging_pkey PRIMARY KEY (audit_id),
    CONSTRAINT ct_eartag_staging_audit_trans_id_fkey FOREIGN KEY (audit_trans_id) REFERENCES cts_transactions.ct_eartag_staging(trans_id)
);

create table if not exists cts_audit.ct_eartags
(
    audit_id bigint GENERATED ALWAYS AS IDENTITY (
        START WITH 1
        INCREMENT BY 1
    ...
    audit_trans_id bigint,
    trans_id bigint,
    CONSTRAINT ct_eartags_audit_action_check CHECK ((audit_action = ANY (ARRAY['UPDATE'::text, 'DELETE'::text]))),
    CONSTRAINT ct_eartags_pkey PRIMARY KEY (audit_id),
    CONSTRAINT ct_eartags_audit_trans_id_fkey FOREIGN KEY (audit_trans_id) REFERENCES cts_transactions.ct_eartags(trans_id)
);

create table if not exists cts_audit.ct_electronic_identifiers
(
    audit_id bigint GENERATED ALWAYS AS IDENTITY (
        START WITH 1
        INCREMENT BY 1
    ...
    row_number numeric,
    trans_id bigint,
    CONSTRAINT ct_electronic_identifiers_audit_action_check CHECK ((audit_action = ANY (ARRAY['UPDATE'::text, 'DELETE'::text]))),
    CONSTRAINT ct_electronic_identifiers_pkey PRIMARY KEY (audit_id),
    CONSTRAINT ct_electronic_identifiers_audit_trans_id_fkey FOREIGN KEY (audit_trans_id) REFERENCES cts_transactions.ct_electronic_identifiers(trans_id)
);

create table if not exists cts_audit.ct_email_log
(
    audit_id bigint GENERATED ALWAYS AS IDENTITY (
        START WITH 1
        INCREMENT BY 1
    ...
    row_number numeric,
    trans_id bigint,
    CONSTRAINT ct_email_log_audit_action_check CHECK ((audit_action = ANY (ARRAY['UPDATE'::text, 'DELETE'::text]))),
    CONSTRAINT ct_email_log_pkey PRIMARY KEY (audit_id),
    CONSTRAINT ct_email_log_audit_trans_id_fkey FOREIGN KEY (audit_trans_id) REFERENCES cts_transactions.ct_email_log(trans_id)
);

create table if not exists cts_audit.ct_ereport_files
(
    audit_id bigint GENERATED ALWAYS AS IDENTITY (
        START WITH 1
        INCREMENT BY 1
    ...
    ere_timestamp date,
    trans_id bigint,
    CONSTRAINT ct_ereport_files_audit_action_check CHECK ((audit_action = ANY (ARRAY['UPDATE'::text, 'DELETE'::text]))),
    CONSTRAINT ct_ereport_files_pkey PRIMARY KEY (audit_id),
    CONSTRAINT ct_ereport_files_audit_trans_id_fkey FOREIGN KEY (audit_trans_id) REFERENCES cts_transactions.ct_ereport_files(trans_id)
);

create table if not exists cts_audit.ct_ereport_load_messages
(
    audit_id bigint GENERATED ALWAYS AS IDENTITY (
        START WITH 1
        INCREMENT BY 1
    ...
    row_number numeric,
    trans_id bigint,
    CONSTRAINT ct_ereport_load_messages_audit_action_check CHECK ((audit_action = ANY (ARRAY['UPDATE'::text, 'DELETE'::text]))),
    CONSTRAINT ct_ereport_load_messages_pkey PRIMARY KEY (audit_id),
    CONSTRAINT ct_ereport_load_messages_audit_trans_id_fkey FOREIGN KEY (audit_trans_id) REFERENCES cts_transactions.ct_ereport_load_messages(trans_id)
);

create table if not exists cts_audit.ct_ereport_locks
(
    audit_id bigint GENERATED ALWAYS AS IDENTITY (
        START WITH 1
        INCREMENT BY 1
    ...
    erl_timestamp date,
    trans_id bigint,
    CONSTRAINT ct_ereport_locks_audit_action_check CHECK ((audit_action = ANY (ARRAY['UPDATE'::text, 'DELETE'::text]))),
    CONSTRAINT ct_ereport_locks_pkey PRIMARY KEY (audit_id),
    CONSTRAINT ct_ereport_locks_audit_trans_id_fkey FOREIGN KEY (audit_trans_id) REFERENCES cts_transactions.ct_ereport_locks(trans_id)
);

create table if not exists cts_audit.ct_ereport_process_messages
(
    audit_id bigint GENERATED ALWAYS AS IDENTITY (
        START WITH 1
        INCREMENT BY 1
    ...
    row_number numeric,
    trans_id bigint,
    CONSTRAINT ct_ereport_process_messages_audit_action_check CHECK ((audit_action = ANY (ARRAY['UPDATE'::text, 'DELETE'::text]))),
    CONSTRAINT ct_ereport_process_messages_pkey PRIMARY KEY (audit_id),
    CONSTRAINT ct_ereport_process_messages_audit_trans_id_fkey FOREIGN KEY (audit_trans_id) REFERENCES cts_transactions.ct_ereport_process_messages(trans_id)
);

create table if not exists cts_audit.ct_ext_cetd_eartag
(
    audit_id bigint GENERATED ALWAYS AS IDENTITY (
        START WITH 1
        INCREMENT BY 1
    ...
    row_number numeric,
    trans_id bigint,
    CONSTRAINT ct_ext_cetd_eartag_audit_action_check CHECK ((audit_action = ANY (ARRAY['UPDATE'::text, 'DELETE'::text]))),
    CONSTRAINT ct_ext_cetd_eartag_pkey PRIMARY KEY (audit_id),
    CONSTRAINT ct_ext_cetd_eartag_audit_trans_id_fkey FOREIGN KEY (audit_trans_id) REFERENCES cts_transactions.ct_ext_cetd_eartag(trans_id)
);

create table if not exists cts_audit.ct_insert_update_log
(
    audit_id bigint GENERATED ALWAYS AS IDENTITY (
        START WITH 1
        INCREMENT BY 1
    ...
    row_number numeric,
    trans_id bigint,
    CONSTRAINT ct_insert_update_log_audit_action_check CHECK ((audit_action = ANY (ARRAY['UPDATE'::text, 'DELETE'::text]))),
    CONSTRAINT ct_insert_update_log_pkey PRIMARY KEY (audit_id),
    CONSTRAINT ct_insert_update_log_audit_trans_id_fkey FOREIGN KEY (audit_trans_id) REFERENCES cts_transactions.ct_insert_update_log(trans_id)
);

create table if not exists cts_audit.ct_issued_documents
(
    audit_id bigint GENERATED ALWAYS AS IDENTITY (
        START WITH 1
        INCREMENT BY 1
    ...
    audit_trans_id bigint,
    trans_id bigint,
    CONSTRAINT ct_issued_documents_audit_action_check CHECK ((audit_action = ANY (ARRAY['UPDATE'::text, 'DELETE'::text]))),
    CONSTRAINT ct_issued_documents_pkey PRIMARY KEY (audit_id),
    CONSTRAINT ct_issued_documents_audit_trans_id_fkey FOREIGN KEY (audit_trans_id) REFERENCES cts_transactions.ct_issued_documents(trans_id)
);

create table if not exists cts_audit.ct_label_requests
(
    audit_id bigint GENERATED ALWAYS AS IDENTITY (
        START WITH 1
        INCREMENT BY 1
    ...
    row_number numeric,
    trans_id bigint,
    CONSTRAINT ct_label_requests_audit_action_check CHECK ((audit_action = ANY (ARRAY['UPDATE'::text, 'DELETE'::text]))),
    CONSTRAINT ct_label_requests_pkey PRIMARY KEY (audit_id),
    CONSTRAINT ct_label_requests_audit_trans_id_fkey FOREIGN KEY (audit_trans_id) REFERENCES cts_transactions.ct_label_requests(trans_id)
);

create table if not exists cts_audit.ct_label_summaries
(
    audit_id bigint GENERATED ALWAYS AS IDENTITY (
        START WITH 1
        INCREMENT BY 1
    ...
    row_number numeric,
    trans_id bigint,
    CONSTRAINT ct_label_summaries_audit_action_check CHECK ((audit_action = ANY (ARRAY['UPDATE'::text, 'DELETE'::text]))),
    CONSTRAINT ct_label_summaries_pkey PRIMARY KEY (audit_id),
    CONSTRAINT ct_label_summaries_audit_trans_id_fkey FOREIGN KEY (audit_trans_id) REFERENCES cts_transactions.ct_label_summaries(trans_id)
);

create table if not exists cts_audit.ct_letters
(
    audit_id bigint GENERATED ALWAYS AS IDENTITY (
        START WITH 1
        INCREMENT BY 1
    ...
    row_number numeric,
    trans_id bigint,
    CONSTRAINT ct_letters_audit_action_check CHECK ((audit_action = ANY (ARRAY['UPDATE'::text, 'DELETE'::text]))),
    CONSTRAINT ct_letters_pkey PRIMARY KEY (audit_id),
    CONSTRAINT ct_letters_audit_trans_id_fkey FOREIGN KEY (audit_trans_id) REFERENCES cts_transactions.ct_letters(trans_id)
);

create table if not exists cts_audit.ct_location_identifiers
(
    audit_id bigint GENERATED ALWAYS AS IDENTITY (
        START WITH 1
        INCREMENT BY 1
    ...
    audit_trans_id bigint,
    trans_id bigint,
    CONSTRAINT ct_location_identifiers_audit_action_check CHECK ((audit_action = ANY (ARRAY['UPDATE'::text, 'DELETE'::text]))),
    CONSTRAINT ct_location_identifiers_pkey PRIMARY KEY (audit_id),
    CONSTRAINT ct_location_identifiers_audit_trans_id_fkey FOREIGN KEY (audit_trans_id) REFERENCES cts_transactions.ct_location_identifiers(trans_id)
);

create table if not exists cts_audit.ct_location_party_rels
(
    audit_id bigint GENERATED ALWAYS AS IDENTITY (
        START WITH 1
        INCREMENT BY 1
    ...
    audit_trans_id bigint,
    trans_id bigint,
    CONSTRAINT ct_location_party_rels_audit_action_check CHECK ((audit_action = ANY (ARRAY['UPDATE'::text, 'DELETE'::text]))),
    CONSTRAINT ct_location_party_rels_pkey PRIMARY KEY (audit_id),
    CONSTRAINT ct_location_party_rels_audit_trans_id_fkey FOREIGN KEY (audit_trans_id) REFERENCES cts_transactions.ct_location_party_rels(trans_id)
);

create table if not exists cts_audit.ct_location_relationships
(
    audit_id bigint GENERATED ALWAYS AS IDENTITY (
        START WITH 1
        INCREMENT BY 1
    ...
    audit_trans_id bigint,
    trans_id bigint,
    CONSTRAINT ct_location_relationships_audit_action_check CHECK ((audit_action = ANY (ARRAY['UPDATE'::text, 'DELETE'::text]))),
    CONSTRAINT ct_location_relationships_pkey PRIMARY KEY (audit_id),
    CONSTRAINT ct_location_relationships_audit_trans_id_fkey FOREIGN KEY (audit_trans_id) REFERENCES cts_transactions.ct_location_relationships(trans_id)
);

create table if not exists cts_audit.ct_locations
(
    audit_id bigint GENERATED ALWAYS AS IDENTITY (
        START WITH 1
        INCREMENT BY 1
    ...
    audit_trans_id bigint,
    trans_id bigint,
    CONSTRAINT ct_locations_audit_action_check CHECK ((audit_action = ANY (ARRAY['UPDATE'::text, 'DELETE'::text]))),
    CONSTRAINT ct_locations_pkey PRIMARY KEY (audit_id),
    CONSTRAINT ct_locations_audit_trans_id_fkey FOREIGN KEY (audit_trans_id) REFERENCES cts_transactions.ct_locations(trans_id)
);

create table if not exists cts_audit.ct_locations_faker
(
    audit_id bigint GENERATED ALWAYS AS IDENTITY (
        START WITH 1
        INCREMENT BY 1
    ...
    loc_comments text,
    trans_id bigint,
    CONSTRAINT ct_locations_faker_audit_action_check CHECK ((audit_action = ANY (ARRAY['UPDATE'::text, 'DELETE'::text]))),
    CONSTRAINT ct_locations_faker_pkey PRIMARY KEY (audit_id),
    CONSTRAINT ct_locations_faker_audit_trans_id_fkey FOREIGN KEY (audit_trans_id) REFERENCES cts_transactions.ct_locations_faker(trans_id)
);

create table if not exists cts_audit.ct_locrestrictionstoanimals
(
    audit_id bigint GENERATED ALWAYS AS IDENTITY (
        START WITH 1
        INCREMENT BY 1
    ...
    row_number numeric,
    trans_id bigint,
    CONSTRAINT ct_locrestrictionstoanimals_audit_action_check CHECK ((audit_action = ANY (ARRAY['UPDATE'::text, 'DELETE'::text]))),
    CONSTRAINT ct_locrestrictionstoanimals_pkey PRIMARY KEY (audit_id),
    CONSTRAINT ct_locrestrictionstoanimals_audit_trans_id_fkey FOREIGN KEY (audit_trans_id) REFERENCES cts_transactions.ct_locrestrictionstoanimals(trans_id)
);

create table if not exists cts_audit.ct_mgt_control_errors
(
    audit_id bigint GENERATED ALWAYS AS IDENTITY (
        START WITH 1
        INCREMENT BY 1
    ...
    row_number numeric,
    trans_id bigint,
    CONSTRAINT ct_mgt_control_errors_audit_action_check CHECK ((audit_action = ANY (ARRAY['UPDATE'::text, 'DELETE'::text]))),
    CONSTRAINT ct_mgt_control_errors_pkey PRIMARY KEY (audit_id),
    CONSTRAINT ct_mgt_control_errors_audit_trans_id_fkey FOREIGN KEY (audit_trans_id) REFERENCES cts_transactions.ct_mgt_control_errors(trans_id)
);

create table if not exists cts_audit.ct_mhs_to_cph
(
    audit_id bigint GENERATED ALWAYS AS IDENTITY (
        START WITH 1
        INCREMENT BY 1
    ...
    row_number numeric,
    trans_id bigint,
    CONSTRAINT ct_mhs_to_cph_audit_action_check CHECK ((audit_action = ANY (ARRAY['UPDATE'::text, 'DELETE'::text]))),
    CONSTRAINT ct_mhs_to_cph_pkey PRIMARY KEY (audit_id),
    CONSTRAINT ct_mhs_to_cph_audit_trans_id_fkey FOREIGN KEY (audit_trans_id) REFERENCES cts_transactions.ct_mhs_to_cph(trans_id)
);

create table if not exists cts_audit.ct_mov_hst
(
    audit_id bigint GENERATED ALWAYS AS IDENTITY (
        START WITH 1
        INCREMENT BY 1
    ...
    row_number numeric,
    trans_id bigint,
    CONSTRAINT ct_mov_hst_audit_action_check CHECK ((audit_action = ANY (ARRAY['UPDATE'::text, 'DELETE'::text]))),
    CONSTRAINT ct_mov_hst_pkey PRIMARY KEY (audit_id),
    CONSTRAINT ct_mov_hst_audit_trans_id_fkey FOREIGN KEY (audit_trans_id) REFERENCES cts_transactions.ct_mov_hst(trans_id)
);

create table if not exists cts_audit.ct_movt_corr_summ_errors
(
    audit_id bigint GENERATED ALWAYS AS IDENTITY (
        START WITH 1
        INCREMENT BY 1
    ...
    row_number numeric,
    trans_id bigint,
    CONSTRAINT ct_movt_corr_summ_errors_audit_action_check CHECK ((audit_action = ANY (ARRAY['UPDATE'::text, 'DELETE'::text]))),
    CONSTRAINT ct_movt_corr_summ_errors_pkey PRIMARY KEY (audit_id),
    CONSTRAINT ct_movt_corr_summ_errors_audit_trans_id_fkey FOREIGN KEY (audit_trans_id) REFERENCES cts_transactions.ct_movt_corr_summ_errors(trans_id)
);

create table if not exists cts_audit.ct_movt_correct_summaries
(
    audit_id bigint GENERATED ALWAYS AS IDENTITY (
        START WITH 1
        INCREMENT BY 1
    ...
    row_number numeric,
    trans_id bigint,
    CONSTRAINT ct_movt_correct_summaries_audit_action_check CHECK ((audit_action = ANY (ARRAY['UPDATE'::text, 'DELETE'::text]))),
    CONSTRAINT ct_movt_correct_summaries_pkey PRIMARY KEY (audit_id),
    CONSTRAINT ct_movt_correct_summaries_audit_trans_id_fkey FOREIGN KEY (audit_trans_id) REFERENCES cts_transactions.ct_movt_correct_summaries(trans_id)
);

create table if not exists cts_audit.ct_parties
(
    audit_id bigint GENERATED ALWAYS AS IDENTITY (
        START WITH 1
        INCREMENT BY 1
    ...
    audit_trans_id bigint,
    trans_id bigint,
    CONSTRAINT ct_parties_audit_action_check CHECK ((audit_action = ANY (ARRAY['UPDATE'::text, 'DELETE'::text]))),
    CONSTRAINT ct_parties_pkey PRIMARY KEY (audit_id),
    CONSTRAINT ct_parties_audit_trans_id_fkey FOREIGN KEY (audit_trans_id) REFERENCES cts_transactions.ct_parties(trans_id)
);

create table if not exists cts_audit.ct_parties_faker
(
    audit_id bigint GENERATED ALWAYS AS IDENTITY (
        START WITH 1
        INCREMENT BY 1
    ...
    trans_id bigint,
    CONSTRAINT ct_parties_faker_audit_action_check CHECK ((audit_action = ANY (ARRAY['UPDATE'::text, 'DELETE'::text]))),
    CONSTRAINT ct_parties_faker_pkey PRIMARY KEY (audit_id),
    CONSTRAINT ct_parties_faker_audit_trans_id_fkey FOREIGN KEY (audit_trans_id) REFERENCES cts_transactions.ct_parties_faker(trans_id)
);

create table if not exists cts_audit.ct_ppaf_groupings
(
    audit_id bigint GENERATED ALWAYS AS IDENTITY (
        START WITH 1
        INCREMENT BY 1
    ...
    row_number numeric,
    trans_id bigint,
    CONSTRAINT ct_ppaf_groupings_audit_action_check CHECK ((audit_action = ANY (ARRAY['UPDATE'::text, 'DELETE'::text]))),
    CONSTRAINT ct_ppaf_groupings_pkey PRIMARY KEY (audit_id),
    CONSTRAINT ct_ppaf_groupings_audit_trans_id_fkey FOREIGN KEY (audit_trans_id) REFERENCES cts_transactions.ct_ppaf_groupings(trans_id)
);

create table if not exists cts_audit.ct_preprinted_appn_forms
(
    audit_id bigint GENERATED ALWAYS AS IDENTITY (
        START WITH 1
        INCREMENT BY 1
    ...
    row_number numeric,
    trans_id bigint,
    CONSTRAINT ct_preprinted_appn_forms_audit_action_check CHECK ((audit_action = ANY (ARRAY['UPDATE'::text, 'DELETE'::text]))),
    CONSTRAINT ct_preprinted_appn_forms_pkey PRIMARY KEY (audit_id),
    CONSTRAINT ct_preprinted_appn_forms_audit_trans_id_fkey FOREIGN KEY (audit_trans_id) REFERENCES cts_transactions.ct_preprinted_appn_forms(trans_id)
);

create table if not exists cts_audit.ct_ps9999_ahdb_data
(
    audit_id bigint GENERATED ALWAYS AS IDENTITY (
        START WITH 1
        INCREMENT BY 1
    ...
    row_number numeric,
    trans_id bigint,
    CONSTRAINT ct_ps9999_ahdb_data_audit_action_check CHECK ((audit_action = ANY (ARRAY['UPDATE'::text, 'DELETE'::text]))),
    CONSTRAINT ct_ps9999_ahdb_data_pkey PRIMARY KEY (audit_id),
    CONSTRAINT ct_ps9999_ahdb_data_audit_trans_id_fkey FOREIGN KEY (audit_trans_id) REFERENCES cts_transactions.ct_ps9999_ahdb_data(trans_id)
);

create table if not exists cts_audit.ct_ps9999_ahdb_mov_history
(
    audit_id bigint GENERATED ALWAYS AS IDENTITY (
        START WITH 1
        INCREMENT BY 1
    ...
    row_number numeric,
    trans_id bigint,
    CONSTRAINT ct_ps9999_ahdb_mov_history_audit_action_check CHECK ((audit_action = ANY (ARRAY['UPDATE'::text, 'DELETE'::text]))),
    CONSTRAINT ct_ps9999_ahdb_mov_history_pkey PRIMARY KEY (audit_id),
    CONSTRAINT ct_ps9999_ahdb_mov_history_audit_trans_id_fkey FOREIGN KEY (audit_trans_id) REFERENCES cts_transactions.ct_ps9999_ahdb_mov_history(trans_id)
);

create table if not exists cts_audit.ct_recd_application_errors
(
    audit_id bigint GENERATED ALWAYS AS IDENTITY (
        START WITH 1
        INCREMENT BY 1
    ...
    row_number numeric,
    trans_id bigint,
    CONSTRAINT ct_recd_application_errors_audit_action_check CHECK ((audit_action = ANY (ARRAY['UPDATE'::text, 'DELETE'::text]))),
    CONSTRAINT ct_recd_application_errors_pkey PRIMARY KEY (audit_id),
    CONSTRAINT ct_recd_application_errors_audit_trans_id_fkey FOREIGN KEY (audit_trans_id) REFERENCES cts_transactions.ct_recd_application_errors(trans_id)
);

create table if not exists cts_audit.ct_recd_movement_errors
(
    audit_id bigint GENERATED ALWAYS AS IDENTITY (
        START WITH 1
        INCREMENT BY 1
    ...
    row_number numeric,
    trans_id bigint,
    CONSTRAINT ct_recd_movement_errors_audit_action_check CHECK ((audit_action = ANY (ARRAY['UPDATE'::text, 'DELETE'::text]))),
    CONSTRAINT ct_recd_movement_errors_pkey PRIMARY KEY (audit_id),
    CONSTRAINT ct_recd_movement_errors_audit_trans_id_fkey FOREIGN KEY (audit_trans_id) REFERENCES cts_transactions.ct_recd_movement_errors(trans_id)
);

create table if not exists cts_audit.ct_received_applications
(
    audit_id bigint GENERATED ALWAYS AS IDENTITY (
        START WITH 1
        INCREMENT BY 1
    ...
    audit_trans_id bigint,
    trans_id bigint,
    CONSTRAINT ct_received_applications_audit_action_check CHECK ((audit_action = ANY (ARRAY['UPDATE'::text, 'DELETE'::text]))),
    CONSTRAINT ct_received_applications_pkey PRIMARY KEY (audit_id),
    CONSTRAINT ct_received_applications_audit_trans_id_fkey FOREIGN KEY (audit_trans_id) REFERENCES cts_transactions.ct_received_applications(trans_id)
);

create table if not exists cts_audit.ct_received_movements
(
    audit_id bigint GENERATED ALWAYS AS IDENTITY (
        START WITH 1
        INCREMENT BY 1
    ...
    audit_trans_id bigint,
    trans_id bigint,
    CONSTRAINT ct_received_movements_audit_action_check CHECK ((audit_action = ANY (ARRAY['UPDATE'::text, 'DELETE'::text]))),
    CONSTRAINT ct_received_movements_pkey PRIMARY KEY (audit_id),
    CONSTRAINT ct_received_movements_audit_trans_id_fkey FOREIGN KEY (audit_trans_id) REFERENCES cts_transactions.ct_received_movements(trans_id)
);

create table if not exists cts_audit.ct_registered_animals
(
    audit_id bigint GENERATED ALWAYS AS IDENTITY (
        START WITH 1
        INCREMENT BY 1
    ...
    audit_trans_id bigint,
    trans_id bigint,
    CONSTRAINT ct_registered_animals_audit_action_check CHECK ((audit_action = ANY (ARRAY['UPDATE'::text, 'DELETE'::text]))),
    CONSTRAINT ct_registered_animals_pkey PRIMARY KEY (audit_id),
    CONSTRAINT ct_registered_animals_audit_trans_id_fkey FOREIGN KEY (audit_trans_id) REFERENCES cts_transactions.ct_registered_animals(trans_id)
);

create table if not exists cts_audit.ct_registered_movements
(
    audit_id bigint GENERATED ALWAYS AS IDENTITY (
        START WITH 1
        INCREMENT BY 1
    ...
    audit_trans_id bigint,
    trans_id bigint,
    CONSTRAINT ct_registered_movements_audit_action_check CHECK ((audit_action = ANY (ARRAY['UPDATE'::text, 'DELETE'::text]))),
    CONSTRAINT ct_registered_movements_pkey PRIMARY KEY (audit_id),
    CONSTRAINT ct_registered_movements_audit_trans_id_fkey FOREIGN KEY (audit_trans_id) REFERENCES cts_transactions.ct_registered_movements(trans_id)
);

create table if not exists cts_audit.ct_reset_to_extract
(
    audit_id bigint GENERATED ALWAYS AS IDENTITY (
        START WITH 1
        INCREMENT BY 1
    ...
    row_number numeric,
    trans_id bigint,
    CONSTRAINT ct_reset_to_extract_audit_action_check CHECK ((audit_action = ANY (ARRAY['UPDATE'::text, 'DELETE'::text]))),
    CONSTRAINT ct_reset_to_extract_pkey PRIMARY KEY (audit_id),
    CONSTRAINT ct_reset_to_extract_audit_trans_id_fkey FOREIGN KEY (audit_trans_id) REFERENCES cts_transactions.ct_reset_to_extract(trans_id)
);

create table if not exists cts_audit.ct_sbcs_ext
(
    audit_id bigint GENERATED ALWAYS AS IDENTITY (
        START WITH 1
        INCREMENT BY 1
    ...
    row_number numeric,
    trans_id bigint,
    CONSTRAINT ct_sbcs_ext_audit_action_check CHECK ((audit_action = ANY (ARRAY['UPDATE'::text, 'DELETE'::text]))),
    CONSTRAINT ct_sbcs_ext_pkey PRIMARY KEY (audit_id),
    CONSTRAINT ct_sbcs_ext_audit_trans_id_fkey FOREIGN KEY (audit_trans_id) REFERENCES cts_transactions.ct_sbcs_ext(trans_id)
);

create table if not exists cts_audit.ct_stage_files
(
    audit_id bigint GENERATED ALWAYS AS IDENTITY (
        START WITH 1
        INCREMENT BY 1
    ...
    row_number numeric,
    trans_id bigint,
    CONSTRAINT ct_stage_files_audit_action_check CHECK ((audit_action = ANY (ARRAY['UPDATE'::text, 'DELETE'::text]))),
    CONSTRAINT ct_stage_files_pkey PRIMARY KEY (audit_id),
    CONSTRAINT ct_stage_files_audit_trans_id_fkey FOREIGN KEY (audit_trans_id) REFERENCES cts_transactions.ct_stage_files(trans_id)
);

create table if not exists cts_audit.ct_stage_locks
(
    audit_id bigint GENERATED ALWAYS AS IDENTITY (
        START WITH 1
        INCREMENT BY 1
    ...
    row_number numeric,
    trans_id bigint,
    CONSTRAINT ct_stage_locks_audit_action_check CHECK ((audit_action = ANY (ARRAY['UPDATE'::text, 'DELETE'::text]))),
    CONSTRAINT ct_stage_locks_pkey PRIMARY KEY (audit_id),
    CONSTRAINT ct_stage_locks_audit_trans_id_fkey FOREIGN KEY (audit_trans_id) REFERENCES cts_transactions.ct_stage_locks(trans_id)
);

create table if not exists cts_audit.ct_stage_messages
(
    audit_id bigint GENERATED ALWAYS AS IDENTITY (
        START WITH 1
        INCREMENT BY 1
    ...
    row_number numeric,
    trans_id bigint,
    CONSTRAINT ct_stage_messages_audit_action_check CHECK ((audit_action = ANY (ARRAY['UPDATE'::text, 'DELETE'::text]))),
    CONSTRAINT ct_stage_messages_pkey PRIMARY KEY (audit_id),
    CONSTRAINT ct_stage_messages_audit_trans_id_fkey FOREIGN KEY (audit_trans_id) REFERENCES cts_transactions.ct_stage_messages(trans_id)
);

create table if not exists cts_audit.ct_susp_animal_errors
(
    audit_id bigint GENERATED ALWAYS AS IDENTITY (
        START WITH 1
        INCREMENT BY 1
    ...
    row_number numeric,
    trans_id bigint,
    CONSTRAINT ct_susp_animal_errors_audit_action_check CHECK ((audit_action = ANY (ARRAY['UPDATE'::text, 'DELETE'::text]))),
    CONSTRAINT ct_susp_animal_errors_pkey PRIMARY KEY (audit_id),
    CONSTRAINT ct_susp_animal_errors_audit_trans_id_fkey FOREIGN KEY (audit_trans_id) REFERENCES cts_transactions.ct_susp_animal_errors(trans_id)
);

create table if not exists cts_audit.ct_susp_cm_measure_results
(
    audit_id bigint GENERATED ALWAYS AS IDENTITY (
        START WITH 1
        INCREMENT BY 1
    ...
    row_number numeric,
    trans_id bigint,
    CONSTRAINT ct_susp_cm_measure_results_audit_action_check CHECK ((audit_action = ANY (ARRAY['UPDATE'::text, 'DELETE'::text]))),
    CONSTRAINT ct_susp_cm_measure_results_pkey PRIMARY KEY (audit_id),
    CONSTRAINT ct_susp_cm_measure_results_audit_trans_id_fkey FOREIGN KEY (audit_trans_id) REFERENCES cts_transactions.ct_susp_cm_measure_results(trans_id)
);

create table if not exists cts_audit.ct_susp_condition_markers
(
    audit_id bigint GENERATED ALWAYS AS IDENTITY (
        START WITH 1
        INCREMENT BY 1
    ...
    audit_trans_id bigint,
    trans_id bigint,
    CONSTRAINT ct_susp_condition_markers_audit_action_check CHECK ((audit_action = ANY (ARRAY['UPDATE'::text, 'DELETE'::text]))),
    CONSTRAINT ct_susp_condition_markers_pkey PRIMARY KEY (audit_id),
    CONSTRAINT ct_susp_condition_markers_audit_trans_id_fkey FOREIGN KEY (audit_trans_id) REFERENCES cts_transactions.ct_susp_condition_markers(trans_id)
);

create table if not exists cts_audit.ct_susp_movement_errors
(
    audit_id bigint GENERATED ALWAYS AS IDENTITY (
        START WITH 1
        INCREMENT BY 1
    ...
    row_number numeric,
    trans_id bigint,
    CONSTRAINT ct_susp_movement_errors_audit_action_check CHECK ((audit_action = ANY (ARRAY['UPDATE'::text, 'DELETE'::text]))),
    CONSTRAINT ct_susp_movement_errors_pkey PRIMARY KEY (audit_id),
    CONSTRAINT ct_susp_movement_errors_audit_trans_id_fkey FOREIGN KEY (audit_trans_id) REFERENCES cts_transactions.ct_susp_movement_errors(trans_id)
);

create table if not exists cts_audit.ct_suspended_animals
(
    audit_id bigint GENERATED ALWAYS AS IDENTITY (
        START WITH 1
        INCREMENT BY 1
    ...
    audit_trans_id bigint,
    trans_id bigint,
    CONSTRAINT ct_suspended_animals_audit_action_check CHECK ((audit_action = ANY (ARRAY['UPDATE'::text, 'DELETE'::text]))),
    CONSTRAINT ct_suspended_animals_pkey PRIMARY KEY (audit_id),
    CONSTRAINT ct_suspended_animals_audit_trans_id_fkey FOREIGN KEY (audit_trans_id) REFERENCES cts_transactions.ct_suspended_animals(trans_id)
);

create table if not exists cts_audit.ct_suspended_movements
(
    audit_id bigint GENERATED ALWAYS AS IDENTITY (
        START WITH 1
        INCREMENT BY 1
    ...
    audit_trans_id bigint,
    trans_id bigint,
    CONSTRAINT ct_suspended_movements_audit_action_check CHECK ((audit_action = ANY (ARRAY['UPDATE'::text, 'DELETE'::text]))),
    CONSTRAINT ct_suspended_movements_pkey PRIMARY KEY (audit_id),
    CONSTRAINT ct_suspended_movements_audit_trans_id_fkey FOREIGN KEY (audit_trans_id) REFERENCES cts_transactions.ct_suspended_movements(trans_id)
);

create table if not exists cts_audit.ct_valid_applications
(
    audit_id bigint GENERATED ALWAYS AS IDENTITY (
        START WITH 1
        INCREMENT BY 1
    ...
    audit_trans_id bigint,
    trans_id bigint,
    CONSTRAINT ct_valid_applications_audit_action_check CHECK ((audit_action = ANY (ARRAY['UPDATE'::text, 'DELETE'::text]))),
    CONSTRAINT ct_valid_applications_pkey PRIMARY KEY (audit_id),
    CONSTRAINT ct_valid_applications_audit_trans_id_fkey FOREIGN KEY (audit_trans_id) REFERENCES cts_transactions.ct_valid_applications(trans_id)
);

create table if not exists cts_audit.ct_web_users
(
    audit_id bigint GENERATED ALWAYS AS IDENTITY (
        START WITH 1
        INCREMENT BY 1
    ...
    row_number numeric,
    trans_id bigint,
    CONSTRAINT ct_web_users_audit_action_check CHECK ((audit_action = ANY (ARRAY['UPDATE'::text, 'DELETE'::text]))),
    CONSTRAINT ct_web_users_pkey PRIMARY KEY (audit_id),
    CONSTRAINT ct_web_users_audit_trans_id_fkey FOREIGN KEY (audit_trans_id) REFERENCES cts_transactions.ct_web_users(trans_id)
);

create table if not exists cts_audit.ct_wg_autoallocations
(
    audit_id bigint GENERATED ALWAYS AS IDENTITY (
        START WITH 1
        INCREMENT BY 1
    ...
    row_number numeric,
    trans_id bigint,
    CONSTRAINT ct_wg_autoallocations_audit_action_check CHECK ((audit_action = ANY (ARRAY['UPDATE'::text, 'DELETE'::text]))),
    CONSTRAINT ct_wg_autoallocations_pkey PRIMARY KEY (audit_id),
    CONSTRAINT ct_wg_autoallocations_audit_trans_id_fkey FOREIGN KEY (audit_trans_id) REFERENCES cts_transactions.ct_wg_autoallocations(trans_id)
);

create table if not exists cts_audit.ct_wg_super_assignments
(
    audit_id bigint GENERATED ALWAYS AS IDENTITY (
        START WITH 1
        INCREMENT BY 1
    ...
    row_number numeric,
    trans_id bigint,
    CONSTRAINT ct_wg_super_assignments_audit_action_check CHECK ((audit_action = ANY (ARRAY['UPDATE'::text, 'DELETE'::text]))),
    CONSTRAINT ct_wg_super_assignments_pkey PRIMARY KEY (audit_id),
    CONSTRAINT ct_wg_super_assignments_audit_trans_id_fkey FOREIGN KEY (audit_trans_id) REFERENCES cts_transactions.ct_wg_super_assignments(trans_id)
);

create table if not exists cts_audit.ct_wg_user_assignments
(
    audit_id bigint GENERATED ALWAYS AS IDENTITY (
        START WITH 1
        INCREMENT BY 1
    ...
    row_number numeric,
    trans_id bigint,
    CONSTRAINT ct_wg_user_assignments_audit_action_check CHECK ((audit_action = ANY (ARRAY['UPDATE'::text, 'DELETE'::text]))),
    CONSTRAINT ct_wg_user_assignments_pkey PRIMARY KEY (audit_id),
    CONSTRAINT ct_wg_user_assignments_audit_trans_id_fkey FOREIGN KEY (audit_trans_id) REFERENCES cts_transactions.ct_wg_user_assignments(trans_id)
);

create table if not exists cts_audit.ct_workgroups
(
    audit_id bigint GENERATED ALWAYS AS IDENTITY (
        START WITH 1
        INCREMENT BY 1
    ...
    row_number numeric,
    trans_id bigint,
    CONSTRAINT ct_workgroups_audit_action_check CHECK ((audit_action = ANY (ARRAY['UPDATE'::text, 'DELETE'::text]))),
    CONSTRAINT ct_workgroups_pkey PRIMARY KEY (audit_id),
    CONSTRAINT ct_workgroups_audit_trans_id_fkey FOREIGN KEY (audit_trans_id) REFERENCES cts_transactions.ct_workgroups(trans_id)
);
