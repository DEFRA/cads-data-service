...
public class S3SqlBulkLoadBackgroundService(
    ...
    IS3SqlScriptExecutorService processor, IServiceScopeFactory serviceScopeFactory)
    : S3BulkLoadBackgroundService<CreateS3SqlImportJobDto>(channel, logger, processor, serviceScopeFactory)
{
}