...
namespace Cads.Cds.SystemAdmin.Infrastructure.GraphQL.Schemas.Cts.Contexts;

public partial class CtsGraphQLDbContext : DbContext
{
    public CtsGraphQLDbContext(DbContextOptions<CtsGraphQLDbContext> options)
        : base(options)
    {
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AdrId).HasName("ct_addresses_pkey");

            entity.ToTable("ct_addresses", "cts");

            entity.HasIndex(e => e.TransId, "ct_addresses_trans_id_idx");

            entity.HasIndex(e => new { e.AdrLocId, e.AdrCurrentModifiedDate, e.AdrId }, "ix_ct_addresses_location")
                .IsDescending(false, true, true)
                .HasFilter("(adr_loc_id IS NOT NULL)")
                .HasNullSortOrder(new[] { NullSortOrder.NullsLast, NullSortOrder.NullsLast, NullSortOrder.NullsFirst });

            entity.HasIndex(e => new { e.AdrParId, e.AdrCurrentModifiedDate, e.AdrId }, "ix_ct_addresses_party")
                .IsDescending(false, true, true)
                .HasFilter("(adr_par_id IS NOT NULL)")
                .HasNullSortOrder(new[] { NullSortOrder.NullsLast, NullSortOrder.NullsLast, NullSortOrder.NullsFirst });
            ...
            entity.HasOne(d => d.AdrLoc).WithMany(p => p.CtAddresses)
                .HasForeignKey(d => d.AdrLocId)
                .HasConstraintName("fk_ct_addresses_adr_loc_id");

            entity.HasOne(d => d.AdrPar).WithMany(p => p.CtAddresses)
                .HasForeignKey(d => d.AdrParId)
                .HasConstraintName("fk_ct_addresses_adr_par_id");
        });

        modelBuilder.Entity<CtAllocRoutine>(entity =>
        {
            entity.HasKey(e => e.RouId).HasName("ct_alloc_routines_pkey");

            entity.ToTable("ct_alloc_routines", "cts");

            entity.HasIndex(e => e.TransId, "ct_alloc_routines_trans_id_idx");
        ...
        {
            entity.HasKey(e => e.AchId).HasName("ct_animal_changes_pkey");

            entity.ToTable("ct_animal_changes", "cts");
            ...
            entity.HasIndex(e => e.TransId, "ct_animal_changes_trans_id_idx");
            ...
            entity.HasOne(d => d.AchLocIdDocIssuedNavigation).WithMany(p => p.CtAnimalChanges)
                .HasForeignKey(d => d.AchLocIdDocIssued)
                .HasConstraintName("fk_ct_animal_changes_ach_loc_id_doc_issued");

            entity.HasOne(d => d.AchMovIdDeathCancelNavigation).WithMany(p => p.CtAnimalChanges)
                .HasForeignKey(d => d.AchMovIdDeathCancel)
                .HasConstraintName("fk_ct_animal_changes_ach_mov_id_death_cancel");

            entity.HasOne(d => d.AchRanIdDocIssuedNavigation).WithMany(p => p.CtAnimalChanges)
                .HasForeignKey(d => d.AchRanIdDocIssued)
                .HasConstraintName("fk_ct_animal_changes_ach_ran_id_doc_issued");
        });

        modelBuilder.Entity<CtAnimalClaim>(entity =>
        {
            entity.HasKey(e => e.AncId).HasName("ct_animal_claims_pkey");

            entity.ToTable("ct_animal_claims", "cts");
            ...
            entity.HasIndex(e => new { e.AncRanId, e.AncSchemeYear }, "ct_animal_claims_anc_ran_id_scheme_year_idx");

            entity.HasIndex(e => new { e.AncRanId, e.AncSchemeYear, e.AncClaimSequence }, "ct_animal_claims_anc_ran_id_scheme_year_sequence_idx");

            entity.HasIndex(e => e.TransId, "ct_animal_claims_trans_id_idx");
            ...
            entity.HasOne(d => d.AncCls).WithMany(p => p.CtAnimalClaims)
                .HasForeignKey(d => d.AncClsId)
                .HasConstraintName("fk_ct_animal_claims_anc_cls_id");

            entity.HasOne(d => d.AncClt).WithMany(p => p.CtAnimalClaims)
                .HasForeignKey(d => d.AncCltId)
                .HasConstraintName("fk_ct_animal_claims_anc_clt_id");

            entity.HasOne(d => d.AncRan).WithMany(p => p.CtAnimalClaims)
                .HasForeignKey(d => d.AncRanId)
                .HasConstraintName("fk_ct_animal_claims_anc_ran_id");
        });

        modelBuilder.Entity<CtAnimalCorrSummError>(entity =>
        {
            entity.HasKey(e => e.AseId).HasName("ct_animal_corr_summ_errors_pkey");

            entity.ToTable("ct_animal_corr_summ_errors", "cts");

            entity.HasIndex(e => e.AseAcsId, "ct_animal_corr_summ_errors_ase_acs_id_idx");

            entity.HasIndex(e => e.TransId, "ct_animal_corr_summ_errors_trans_id_idx");
            ...
            entity.HasOne(d => d.AseAcs).WithMany(p => p.CtAnimalCorrSummErrors)
                .HasForeignKey(d => d.AseAcsId)
                .HasConstraintName("fk_ct_animal_corr_summ_errors_ase_acs_id");
        });

        modelBuilder.Entity<CtAnimalCorrectSummary>(entity =>
        {
            entity.HasKey(e => e.AcsId).HasName("ct_animal_correct_summaries_pkey");

            entity.ToTable("ct_animal_correct_summaries", "cts");
            ...
            entity.HasIndex(e => e.TransId, "ct_animal_correct_summaries_trans_id_idx");
            ...
            entity.HasOne(d => d.AcsRan).WithMany(p => p.CtAnimalCorrectSummaries)
                .HasForeignKey(d => d.AcsRanId)
                .HasConstraintName("fk_ct_animal_correct_summaries_acs_ran_id");

            entity.HasOne(d => d.AcsRap).WithMany(p => p.CtAnimalCorrectSummaries)
                .HasForeignKey(d => d.AcsRapId)
                .HasConstraintName("fk_ct_animal_correct_summaries_acs_rap_id");

            entity.HasOne(d => d.AcsSan).WithMany(p => p.CtAnimalCorrectSummaries)
                .HasForeignKey(d => d.AcsSanId)
                .HasConstraintName("fk_ct_animal_correct_summaries_acs_san_id");

            entity.HasOne(d => d.AcsVap).WithMany(p => p.CtAnimalCorrectSummaries)
                .HasForeignKey(d => d.AcsVapId)
                .HasConstraintName("fk_ct_animal_correct_summaries_acs_vap_id");
        });

        modelBuilder.Entity<CtAnimalIdentifier>(entity =>
        {
            entity.HasKey(e => e.AidId).HasName("ct_animal_identifiers_pkey");

            entity.ToTable("ct_animal_identifiers", "cts");
            ...
            entity.HasIndex(e => e.AidCurrentStatus, "ct_animal_identifiers_aid_current_status_idx");
            ...
            entity.HasIndex(e => e.AidIdentifier, "ct_animal_identifiers_aid_identifier_idx");
            ...
            entity.HasIndex(e => e.TransId, "ct_animal_identifiers_trans_id_idx");
            ...
            entity.HasOne(d => d.AidAidIdOriginalNavigation).WithMany(p => p.InverseAidAidIdOriginalNavigation)
                .HasForeignKey(d => d.AidAidIdOriginal)
                .HasConstraintName("fk_ct_animal_identifiers_aid_aid_id_original");

            entity.HasOne(d => d.AidAidIdPreviousNavigation).WithMany(p => p.InverseAidAidIdPreviousNavigation)
                .HasForeignKey(d => d.AidAidIdPrevious)
                .HasConstraintName("fk_ct_animal_identifiers_aid_aid_id_previous");

            entity.HasOne(d => d.AidEid).WithMany(p => p.CtAnimalIdentifiers)
                .HasForeignKey(d => d.AidEidId)
                .HasConstraintName("fk_ct_animal_identifiers_aid_eid_id");

            entity.HasOne(d => d.AidEtg).WithMany(p => p.CtAnimalIdentifiers)
                .HasForeignKey(d => d.AidEtgId)
                .HasConstraintName("fk_ct_animal_identifiers_aid_etg_id");

            entity.HasOne(d => d.AidLocIdAssignedNavigation).WithMany(p => p.CtAnimalIdentifiers)
                .HasForeignKey(d => d.AidLocIdAssigned)
                .HasConstraintName("fk_ct_animal_identifiers_aid_loc_id_assigned");

            entity.HasOne(d => d.AidRan).WithMany(p => p.CtAnimalIdentifiers)
                .HasForeignKey(d => d.AidRanId)
                .HasConstraintName("fk_ct_animal_identifiers_aid_ran_id");
        });

        modelBuilder.Entity<CtAnimalRelationship>(entity =>
        {
            entity.HasKey(e => e.AarId).HasName("ct_animal_relationships_pkey");

            entity.ToTable("ct_animal_relationships", "cts");
            ...
            entity.HasIndex(e => e.TransId, "ct_animal_relationships_trans_id_idx");
            ...
            entity.HasOne(d => d.AarLoc).WithMany(p => p.CtAnimalRelationships)
                .HasForeignKey(d => d.AarLocId)
                .HasConstraintName("fk_ct_animal_relationships_aar_loc_id");

            entity.HasOne(d => d.AarRanIdChildNavigation).WithMany(p => p.CtAnimalRelationshipAarRanIdChildNavigations)
                .HasForeignKey(d => d.AarRanIdChild)
                .HasConstraintName("fk_ct_animal_relationships_aar_ran_id_child");

            entity.HasOne(d => d.AarRanIdParentNavigation).WithMany(p => p.CtAnimalRelationshipAarRanIdParentNavigations)
                .HasForeignKey(d => d.AarRanIdParent)
                .HasConstraintName("fk_ct_animal_relationships_aar_ran_id_parent");
        });

        modelBuilder.Entity<CtAnimalStatus>(entity =>
        {
            entity.HasKey(e => e.AstId).HasName("ct_animal_statuses_pkey");

            entity.ToTable("ct_animal_statuses", "cts");

            entity.HasIndex(e => e.AstRanId, "ct_animal_statuses_ast_ran_id_idx");

            entity.HasIndex(e => e.TransId, "ct_animal_statuses_trans_id_idx");
            ...
            entity.HasOne(d => d.AstRan).WithMany(p => p.CtAnimalStatuses)
                .HasForeignKey(d => d.AstRanId)
                .HasConstraintName("fk_ct_animal_statuses_ast_ran_id");
        });

        modelBuilder.Entity<CtApplicStatus>(entity =>
        {
            entity.HasKey(e => e.ApsId).HasName("ct_applic_statuses_pkey");

            entity.ToTable("ct_applic_statuses", "cts");

            entity.HasIndex(e => e.ApsVapId, "ct_applic_statuses_aps_vap_id_idx");

            entity.HasIndex(e => e.TransId, "ct_applic_statuses_trans_id_idx");
            ...
            entity.HasOne(d => d.ApsVap).WithMany(p => p.CtApplicStatuses)
                .HasForeignKey(d => d.ApsVapId)
                .HasConstraintName("fk_ct_applic_statuses_aps_vap_id");
        });

        modelBuilder.Entity<CtApplicationLateDay>(entity =>
        {
            entity.HasKey(e => e.AldId).HasName("ct_application_late_days_pkey");

            entity.ToTable("ct_application_late_days", "cts");

            entity.HasIndex(e => e.TransId, "ct_application_late_days_trans_id_idx");
        ...
        modelBuilder.Entity<CtBatchRetentionConf>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("ct_batch_retention_conf", "cts");

            entity.HasIndex(e => e.TransId, "ct_batch_retention_conf_trans_id_idx");
        ...
        {
            entity.HasKey(e => e.BrdId).HasName("ct_breeds_pkey");

            entity.ToTable("ct_breeds", "cts");

            entity.HasIndex(e => e.BrdCurrentStatus, "ct_breeds_brd_current_status_idx");

            entity.HasIndex(e => new { e.BrdType, e.BrdCode }, "ct_breeds_brd_type_brd_code_idx");

            entity.HasIndex(e => e.TransId, "ct_breeds_trans_id_idx");
        ...
        {
            entity.HasKey(e => e.CleId).HasName("ct_cla_extract_pkey");

            entity.ToTable("ct_cla_extract", "cts");

            entity.HasIndex(e => e.TransId, "ct_cla_extract_trans_id_idx");
        ...
        {
            entity.HasKey(e => e.CldId).HasName("ct_cla_extract_detail_pkey");

            entity.ToTable("ct_cla_extract_detail", "cts");

            entity.HasIndex(e => e.CldCleId, "ct_cla_extract_detail_cld_cle_id_idx");

            entity.HasIndex(e => e.TransId, "ct_cla_extract_detail_trans_id_idx");
            ...
            entity.HasOne(d => d.CldCle).WithMany(p => p.CtClaExtractDetails)
                .HasForeignKey(d => d.CldCleId)
                .HasConstraintName("fk_ct_cla_extract_detail_cld_cle_id");
        });

        modelBuilder.Entity<CtClaExtractDm>(entity =>
        {
            entity.HasKey(e => e.CleId).HasName("ct_cla_extract_dm_pkey");

            entity.ToTable("ct_cla_extract_dm", "cts");

            entity.HasIndex(e => e.TransId, "ct_cla_extract_dm_trans_id_idx");
        ...
        {
            entity.HasKey(e => e.CldId).HasName("ct_cla_mini_detail_pkey");

            entity.ToTable("ct_cla_mini_detail", "cts");

            entity.HasIndex(e => e.CldCleId, "ct_cla_mini_detail_cld_cle_id_idx");

            entity.HasIndex(e => e.TransId, "ct_cla_mini_detail_trans_id_idx");
            ...
            entity.HasOne(d => d.CldCle).WithMany(p => p.CtClaMiniDetails)
                .HasForeignKey(d => d.CldCleId)
                .HasConstraintName("fk_ct_cla_mini_detail_cld_cle_id");
        });

        modelBuilder.Entity<CtClaMiniExtract>(entity =>
        {
            entity.HasKey(e => e.CleId).HasName("ct_cla_mini_extract_pkey");

            entity.ToTable("ct_cla_mini_extract", "cts");

            entity.HasIndex(e => e.TransId, "ct_cla_mini_extract_trans_id_idx");
        ...
        {
            entity.HasKey(e => e.ClsId).HasName("ct_claim_statuses_pkey");

            entity.ToTable("ct_claim_statuses", "cts");

            entity.HasIndex(e => e.TransId, "ct_claim_statuses_trans_id_idx");
        ...
        {
            entity.HasKey(e => e.CltId).HasName("ct_claim_types_pkey");

            entity.ToTable("ct_claim_types", "cts");

            entity.HasIndex(e => e.CltSchId, "ct_claim_types_clt_sch_id_idx");

            entity.HasIndex(e => e.TransId, "ct_claim_types_trans_id_idx");
            ...
            entity.HasOne(d => d.CltSch).WithMany(p => p.CtClaimTypes)
                .HasForeignKey(d => d.CltSchId)
                .HasConstraintName("fk_ct_claim_types_clt_sch_id");
        });

        modelBuilder.Entity<CtCmAuthority>(entity =>
        {
            entity.HasKey(e => e.CmaId).HasName("ct_cm_authorities_pkey");

            entity.ToTable("ct_cm_authorities", "cts");

            entity.HasIndex(e => e.CmaCotId, "ct_cm_authorities_cma_cot_id_idx");

            entity.HasIndex(e => e.TransId, "ct_cm_authorities_trans_id_idx");
            ...
            entity.HasOne(d => d.CmaCot).WithMany(p => p.CtCmAuthorities)
                .HasForeignKey(d => d.CmaCotId)
                .HasConstraintName("fk_ct_cm_authorities_cma_cot_id");
        });

        modelBuilder.Entity<CtCmMeasuresResult>(entity =>
        {
            entity.HasKey(e => e.CmrId).HasName("ct_cm_measures_results_pkey");

            entity.ToTable("ct_cm_measures_results", "cts");

            entity.HasIndex(e => e.CmrComId, "ct_cm_measures_results_cmr_com_id_idx");

            entity.HasIndex(e => e.TransId, "ct_cm_measures_results_trans_id_idx");
            ...
            entity.HasOne(d => d.CmrCom).WithMany(p => p.CtCmMeasuresResults)
                .HasForeignKey(d => d.CmrComId)
                .HasConstraintName("fk_ct_cm_measures_results_cmr_com_id");
        });

        modelBuilder.Entity<CtCommsAddress>(entity =>
        {
            entity.HasKey(e => e.CoaId).HasName("ct_comms_addresses_pkey");

            entity.ToTable("ct_comms_addresses", "cts");

            entity.HasIndex(e => e.TransId, "ct_comms_addresses_trans_id_idx");
        ...
        {
            entity.HasKey(e => e.CvgId).HasName("ct_cond_variant_groupings_pkey");

            entity.ToTable("ct_cond_variant_groupings", "cts");

            entity.HasIndex(e => e.CvgCovId, "ct_cond_variant_groupings_cvg_cov_id_idx");

            entity.HasIndex(e => e.TransId, "ct_cond_variant_groupings_trans_id_idx");
            ...
            entity.HasOne(d => d.CvgCov).WithMany(p => p.CtCondVariantGroupings)
                .HasForeignKey(d => d.CvgCovId)
                .HasConstraintName("fk_ct_cond_variant_groupings_cvg_cov_id");
        });

        modelBuilder.Entity<CtCondition>(entity =>
        {
            entity.HasKey(e => e.ConId).HasName("ct_conditions_pkey");

            entity.ToTable("ct_conditions", "cts");

            entity.HasIndex(e => e.ConCotId, "ct_conditions_con_cot_id_idx");

            entity.HasIndex(e => e.ConPchId, "ct_conditions_con_pch_id_idx");

            entity.HasIndex(e => e.TransId, "ct_conditions_trans_id_idx");
            ...
            entity.HasOne(d => d.ConCot).WithMany(p => p.CtConditions)
                .HasForeignKey(d => d.ConCotId)
                .HasConstraintName("fk_ct_conditions_con_cot_id");

            entity.HasOne(d => d.ConPch).WithMany(p => p.CtConditions)
                .HasForeignKey(d => d.ConPchId)
                .HasConstraintName("fk_ct_conditions_con_pch_id");
        });

        modelBuilder.Entity<CtConditionActivity>(entity =>
        {
            entity.HasKey(e => e.CacId).HasName("ct_condition_activities_pkey");

            entity.ToTable("ct_condition_activities", "cts");

            entity.HasIndex(e => e.CacConId, "ct_condition_activities_cac_con_id_idx");

            entity.HasIndex(e => e.TransId, "ct_condition_activities_trans_id_idx");
            ...
            entity.HasOne(d => d.CacCon).WithMany(p => p.CtConditionActivities)
                .HasForeignKey(d => d.CacConId)
                .HasConstraintName("fk_ct_condition_activities_cac_con_id");
        });

        modelBuilder.Entity<CtConditionMarker>(entity =>
        {
            entity.HasKey(e => e.ComId).HasName("ct_condition_markers_pkey");

            entity.ToTable("ct_condition_markers", "cts");
            ...
            entity.HasIndex(e => e.TransId, "ct_condition_markers_trans_id_idx");

            entity.HasIndex(e => new { e.ComRanId, e.ComEffectiveToDate, e.ComEffectiveFromDate }, "ix_ct_condition_markers_active_animal").HasFilter("(((com_current_status)::text = '1'::text) AND (com_ran_id IS NOT NULL))");
            ...
            entity.HasOne(d => d.ComCac).WithMany(p => p.CtConditionMarkers)
                .HasForeignKey(d => d.ComCacId)
                .HasConstraintName("ct_condition_markers_com_cac_id_fkey");

            entity.HasOne(d => d.ComCma).WithMany(p => p.CtConditionMarkers)
                .HasForeignKey(d => d.ComCmaId)
                .HasConstraintName("ct_condition_markers_com_cma_id_fkey");

            entity.HasOne(d => d.ComCov).WithMany(p => p.CtConditionMarkers)
                .HasForeignKey(d => d.ComCovId)
                .HasConstraintName("ct_condition_markers_com_cov_id_fkey");

            entity.HasOne(d => d.ComLoc).WithMany(p => p.CtConditionMarkers)
                .HasForeignKey(d => d.ComLocId)
                .HasConstraintName("ct_condition_markers_com_loc_id_fkey");

            entity.HasOne(d => d.ComMov).WithMany(p => p.CtConditionMarkers)
                .HasForeignKey(d => d.ComMovId)
                .HasConstraintName("ct_condition_markers_com_mov_id_fkey");

            entity.HasOne(d => d.ComRan).WithMany(p => p.CtConditionMarkers)
                .HasForeignKey(d => d.ComRanId)
                .HasConstraintName("ct_condition_markers_com_ran_id_fkey");
        });

        modelBuilder.Entity<CtConditionMarkerError>(entity =>
        {
            entity.HasKey(e => e.CmeId).HasName("ct_condition_marker_errors_pkey");

            entity.ToTable("ct_condition_marker_errors", "cts");

            entity.HasIndex(e => e.CmeScmId, "ct_condition_marker_errors_cme_scm_id_idx");

            entity.HasIndex(e => e.TransId, "ct_condition_marker_errors_trans_id_idx");
            ...
            entity.HasOne(d => d.CmeScm).WithMany(p => p.CtConditionMarkerErrors)
                .HasForeignKey(d => d.CmeScmId)
                .HasConstraintName("fk_ct_condition_marker_errors_cme_scm_id");
        });

        modelBuilder.Entity<CtConditionType>(entity =>
        {
            entity.HasKey(e => e.CotId).HasName("ct_condition_types_pkey");

            entity.ToTable("ct_condition_types", "cts");

            entity.HasIndex(e => e.TransId, "ct_condition_types_trans_id_idx");
        ...
        {
            entity.HasKey(e => e.CovId).HasName("ct_condition_variants_pkey");

            entity.ToTable("ct_condition_variants", "cts");

            entity.HasIndex(e => e.CovConId, "ct_condition_variants_cov_con_id_idx");

            entity.HasIndex(e => e.TransId, "ct_condition_variants_trans_id_idx");
            ...
            entity.HasOne(d => d.CovCon).WithMany(p => p.CtConditionVariants)
                .HasForeignKey(d => d.CovConId)
                .HasConstraintName("fk_ct_condition_variants_cov_con_id");
        });

        modelBuilder.Entity<CtCountiesMigration>(entity =>
        {
            entity.HasKey(e => e.CtyId).HasName("ct_counties_migration_pkey");

            entity.ToTable("ct_counties_migration", "cts");

            entity.HasIndex(e => e.TransId, "ct_counties_migration_trans_id_idx");
        ...
        {
            entity.HasKey(e => e.CryId).HasName("ct_countries_pkey");

            entity.ToTable("ct_countries", "cts");

            entity.HasIndex(e => e.CryCryIdMainEu, "ct_countries_cry_cry_id_main_eu_idx");

            entity.HasIndex(e => e.CryCurrentStatus, "ct_countries_cry_current_status_idx");

            entity.HasIndex(e => e.TransId, "ct_countries_trans_id_idx");
            ...
            entity.HasOne(d => d.CryCryIdMainEuNavigation).WithMany(p => p.InverseCryCryIdMainEuNavigation)
                .HasForeignKey(d => d.CryCryIdMainEu)
                .HasConstraintName("fk_ct_countries_cry_cry_id_main_eu");
        });

        modelBuilder.Entity<CtCounty>(entity =>
        {
            entity.HasKey(e => e.CtyId).HasName("ct_counties_pkey");

            entity.ToTable("ct_counties", "cts");

            entity.HasIndex(e => e.TransId, "ct_counties_trans_id_idx");
        ...
        {
            entity.HasKey(e => e.KnsId).HasName("ct_cps167_report_pkey");

            entity.ToTable("ct_cps167_report", "cts");

            entity.HasIndex(e => e.TransId, "ct_cps167_report_trans_id_idx");
        ...
        modelBuilder.Entity<CtCts164HandshakeFileKey>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("ct_cts164_handshake_file_keys", "cts");

            entity.HasIndex(e => e.TransId, "ct_cts164_handshake_file_keys_trans_id_idx");
        ...
        {
            entity.HasKey(e => e.CusId).HasName("ct_cts_users_pkey");

            entity.ToTable("ct_cts_users", "cts");

            entity.HasIndex(e => e.TransId, "ct_cts_users_trans_id_idx");
        ...
        {
            entity.HasKey(e => e.EtgId).HasName("ct_eartags_pkey");

            entity.ToTable("ct_eartags", "cts");
            ...
            entity.HasIndex(e => e.TransId, "ct_eartags_trans_id_idx");
            ...
            entity.HasOne(d => d.EtgErf).WithMany(p => p.CtEartags)
                .HasForeignKey(d => d.EtgErfId)
                .HasConstraintName("fk_ct_eartags_etg_erf_id");

            entity.HasOne(d => d.EtgEtt).WithMany(p => p.CtEartags)
                .HasForeignKey(d => d.EtgEttId)
                .HasConstraintName("fk_ct_eartags_etg_ett_id");

            entity.HasOne(d => d.EtgLocIdOrderNavigation).WithMany(p => p.CtEartags)
                .HasForeignKey(d => d.EtgLocIdOrder)
                .HasConstraintName("fk_ct_eartags_etg_loc_id_order");
        });

        modelBuilder.Entity<CtEartagFormat>(entity =>
        {
            entity.HasKey(e => e.EtfId).HasName("ct_eartag_formats_pkey");

            entity.ToTable("ct_eartag_formats", "cts");

            entity.HasIndex(e => e.TransId, "ct_eartag_formats_trans_id_idx");
        ...
        {
            entity.HasKey(e => e.EtrId).HasName("ct_eartag_reasons_pkey");

            entity.ToTable("ct_eartag_reasons", "cts");

            entity.HasIndex(e => e.TransId, "ct_eartag_reasons_trans_id_idx");
        ...
        {
            entity.HasKey(e => e.ErfId).HasName("ct_eartag_reason_flags_pkey");

            entity.ToTable("ct_eartag_reason_flags", "cts");

            entity.HasIndex(e => e.ErfEtrId, "ct_eartag_reason_flags_erf_etr_id_idx");

            entity.HasIndex(e => e.TransId, "ct_eartag_reason_flags_trans_id_idx");
            ...
            entity.HasOne(d => d.ErfEtr).WithMany(p => p.CtEartagReasonFlags)
                .HasForeignKey(d => d.ErfEtrId)
                .HasConstraintName("fk_ct_eartag_reason_flags_erf_etr_id");
        });

        modelBuilder.Entity<CtEartagStaging>(entity =>
        {
            entity.HasKey(e => e.EstId).HasName("ct_eartag_staging_pkey");

            entity.ToTable("ct_eartag_staging", "cts");
            ...
            entity.HasIndex(e => e.TransId, "ct_eartag_staging_trans_id_idx");
            ...
            entity.HasOne(d => d.EstErf).WithMany(p => p.CtEartagStagings)
                .HasForeignKey(d => d.EstErfId)
                .HasConstraintName("fk_ct_eartag_staging_est_erf_id");

            entity.HasOne(d => d.EstLocIdOrderNavigation).WithMany(p => p.CtEartagStagings)
                .HasForeignKey(d => d.EstLocIdOrder)
                .HasConstraintName("fk_ct_eartag_staging_est_loc_id_order");
        });

        modelBuilder.Entity<CtEartagType>(entity =>
        {
            entity.HasKey(e => e.EttId).HasName("ct_eartag_types_pkey");

            entity.ToTable("ct_eartag_types", "cts");

            entity.HasIndex(e => e.EttEtfId, "ct_eartag_types_ett_etf_id_idx");

            entity.HasIndex(e => e.TransId, "ct_eartag_types_trans_id_idx");
            ...
            entity.HasOne(d => d.EttEtf).WithMany(p => p.CtEartagTypes)
                .HasForeignKey(d => d.EttEtfId)
                .HasConstraintName("fk_ct_eartag_types_ett_etf_id");
        });

        modelBuilder.Entity<CtElectronicIdentifier>(entity =>
        {
            entity.HasKey(e => e.EidId).HasName("ct_electronic_identifiers_pkey");

            entity.ToTable("ct_electronic_identifiers", "cts");

            entity.HasIndex(e => e.EidIsaId, "ct_electronic_identifiers_eid_isa_id_idx");

            entity.HasIndex(e => e.TransId, "ct_electronic_identifiers_trans_id_idx");
            ...
            entity.HasOne(d => d.EidIsa).WithMany(p => p.CtElectronicIdentifiers)
                .HasForeignKey(d => d.EidIsaId)
                .HasConstraintName("fk_ct_electronic_identifiers_eid_isa_id");
        });

        modelBuilder.Entity<CtEmailLog>(entity =>
        {
            entity.HasKey(e => e.EmlId).HasName("ct_email_log_pkey");

            entity.ToTable("ct_email_log", "cts");

            entity.HasIndex(e => e.TransId, "ct_email_log_trans_id_idx");
        ...
        {
            entity.HasKey(e => e.EreId).HasName("ct_ereport_files_pkey");

            entity.ToTable("ct_ereport_files", "cts");

            entity.HasIndex(e => e.TransId, "ct_ereport_files_trans_id_idx");
        ...
        modelBuilder.Entity<CtEreportLoadMessage>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("ct_ereport_load_messages", "cts");

            entity.HasIndex(e => e.TransId, "ct_ereport_load_messages_trans_id_idx");
        ...
        modelBuilder.Entity<CtEreportLock>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("ct_ereport_locks", "cts");

            entity.HasIndex(e => e.TransId, "ct_ereport_locks_trans_id_idx");
        ...
        modelBuilder.Entity<CtEreportProcessMessage>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("ct_ereport_process_messages", "cts");

            entity.HasIndex(e => e.TransId, "ct_ereport_process_messages_trans_id_idx");
        ...
        modelBuilder.Entity<CtExtCetdEartag>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("ct_ext_cetd_eartag", "cts");

            entity.HasIndex(e => e.TransId, "ct_ext_cetd_eartag_trans_id_idx");
        ...
        modelBuilder.Entity<CtExtNiDistrict>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("ct_ext_ni_district", "cts");

            entity.HasIndex(e => e.TransId, "ct_ext_ni_district_trans_id_idx");
        ...
        modelBuilder.Entity<CtExtSpecialHerd>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("ct_ext_special_herd", "cts");

            entity.HasIndex(e => e.TransId, "ct_ext_special_herd_trans_id_idx");
        ...
        modelBuilder.Entity<CtFileLayout>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("ct_file_layouts", "cts");

            entity.HasIndex(e => e.TransId, "ct_file_layouts_trans_id_idx");
        ...
        modelBuilder.Entity<CtHsfSequence>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("ct_hsf_sequences", "cts");

            entity.HasIndex(e => e.TransId, "ct_hsf_sequences_trans_id_idx");
        ...
        {
            entity.HasKey(e => e.IulId).HasName("ct_insert_update_log_pkey");

            entity.ToTable("ct_insert_update_log", "cts");

            entity.HasIndex(e => e.TransId, "ct_insert_update_log_trans_id_idx");
        ...
        {
            entity.HasKey(e => e.IdoId).HasName("ct_issued_documents_pkey");

            entity.ToTable("ct_issued_documents", "cts");
            ...
            entity.HasIndex(e => e.TransId, "ct_issued_documents_trans_id_idx");
            ...
            entity.HasOne(d => d.IdoLoc).WithMany(p => p.CtIssuedDocuments)
                .HasForeignKey(d => d.IdoLocId)
                .HasConstraintName("fk_ct_issued_documents_ido_loc_id");

            entity.HasOne(d => d.IdoRan).WithMany(p => p.CtIssuedDocuments)
                .HasForeignKey(d => d.IdoRanId)
                .HasConstraintName("fk_ct_issued_documents_ido_ran_id");
        });

        modelBuilder.Entity<CtIssuingAuthority>(entity =>
        {
            entity.HasKey(e => e.IsaId).HasName("ct_issuing_authorities_pkey");

            entity.ToTable("ct_issuing_authorities", "cts");

            entity.HasIndex(e => e.TransId, "ct_issuing_authorities_trans_id_idx");
        ...
        {
            entity.HasKey(e => e.LarId).HasName("ct_label_requests_pkey");

            entity.ToTable("ct_label_requests", "cts");

            entity.HasIndex(e => e.LarLasId, "ct_label_requests_lar_las_id_idx");

            entity.HasIndex(e => e.TransId, "ct_label_requests_trans_id_idx");
            ...
            entity.HasOne(d => d.LarLas).WithMany(p => p.CtLabelRequests)
                .HasForeignKey(d => d.LarLasId)
                .HasConstraintName("fk_ct_label_requests_lar_las_id");
        });

        modelBuilder.Entity<CtLabelSummary>(entity =>
        {
            entity.HasKey(e => e.LasId).HasName("ct_label_summaries_pkey");

            entity.ToTable("ct_label_summaries", "cts");
            ...
            entity.HasIndex(e => e.TransId, "ct_label_summaries_trans_id_idx");
            ...
            entity.HasOne(d => d.LasLocIdIdentifyingNavigation).WithMany(p => p.CtLabelSummaryLasLocIdIdentifyingNavigations)
                .HasForeignKey(d => d.LasLocIdIdentifying)
                .HasConstraintName("fk_ct_label_summaries_las_loc_id_identifying");

            entity.HasOne(d => d.LasLocIdLabelsNavigation).WithMany(p => p.CtLabelSummaryLasLocIdLabelsNavigations)
                .HasForeignKey(d => d.LasLocIdLabels)
                .HasConstraintName("fk_ct_label_summaries_las_loc_id_labels");
        });

        modelBuilder.Entity<CtLateDay>(entity =>
        {
            entity.HasKey(e => e.LdaId).HasName("ct_late_days_pkey");

            entity.ToTable("ct_late_days", "cts");

            entity.HasIndex(e => e.TransId, "ct_late_days_trans_id_idx");
        ...
        {
            entity.HasKey(e => e.LetId).HasName("ct_letters_pkey");

            entity.ToTable("ct_letters", "cts");

            entity.HasIndex(e => e.LetWgpId, "ct_letters_let_wgp_id_idx");

            entity.HasIndex(e => e.LetWgpIdSent, "ct_letters_let_wgp_id_sent_idx");

            entity.HasIndex(e => e.TransId, "ct_letters_trans_id_idx");
            ...
            entity.HasOne(d => d.LetWgp).WithMany(p => p.CtLetterLetWgps)
                .HasForeignKey(d => d.LetWgpId)
                .HasConstraintName("fk_ct_letters_let_wgp_id");

            entity.HasOne(d => d.LetWgpIdSentNavigation).WithMany(p => p.CtLetterLetWgpIdSentNavigations)
                .HasForeignKey(d => d.LetWgpIdSent)
                .HasConstraintName("fk_ct_letters_let_wgp_id_sent");
        });

        modelBuilder.Entity<CtLocTypeRelComb>(entity =>
        {
            entity.HasKey(e => e.LrcId).HasName("ct_loc_type_rel_combs_pkey");

            entity.ToTable("ct_loc_type_rel_combs", "cts");
            ...
            entity.HasIndex(e => e.TransId, "ct_loc_type_rel_combs_trans_id_idx");
            ...
            entity.HasOne(d => d.LrcLrt).WithMany(p => p.CtLocTypeRelCombs)
                .HasForeignKey(d => d.LrcLrtId)
                .HasConstraintName("fk_ct_loc_type_rel_combs_lrc_lrt_id");

            entity.HasOne(d => d.LrcLtyId1Navigation).WithMany(p => p.CtLocTypeRelCombLrcLtyId1Navigations)
                .HasForeignKey(d => d.LrcLtyId1)
                .HasConstraintName("fk_ct_loc_type_rel_combs_lrc_lty_id_1");

            entity.HasOne(d => d.LrcLtyId2Navigation).WithMany(p => p.CtLocTypeRelCombLrcLtyId2Navigations)
                .HasForeignKey(d => d.LrcLtyId2)
                .HasConstraintName("fk_ct_loc_type_rel_combs_lrc_lty_id_2");
        });

        modelBuilder.Entity<CtLocation>(entity =>
        {
            entity.HasKey(e => e.LocId).HasName("ct_locations_pkey");

            entity.ToTable("ct_locations", "cts");

            entity.HasIndex(e => e.LocCtyId, "ct_locations_loc_cty_id_idx");

            entity.HasIndex(e => e.LocCurrentStatus, "ct_locations_loc_current_status_idx");

            entity.HasIndex(e => e.LocLtyId, "ct_locations_loc_lty_id_idx");

            entity.HasIndex(e => e.LocSltId, "ct_locations_loc_slt_id_idx");

            entity.HasIndex(e => e.TransId, "ct_locations_trans_id_idx");
            ...
            entity.HasOne(d => d.LocCty).WithMany(p => p.CtLocations)
                .HasForeignKey(d => d.LocCtyId)
                .HasConstraintName("fk_ct_locations_loc_cty_id");

            entity.HasOne(d => d.LocLty).WithMany(p => p.CtLocations)
                .HasForeignKey(d => d.LocLtyId)
                .HasConstraintName("fk_ct_locations_loc_lty_id");

            entity.HasOne(d => d.LocSlt).WithMany(p => p.CtLocations)
                .HasForeignKey(d => d.LocSltId)
                .HasConstraintName("fk_ct_locations_loc_slt_id");
        });

        modelBuilder.Entity<CtLocationIdFormat>(entity =>
        {
            entity.HasKey(e => e.LifId).HasName("ct_location_id_formats_pkey");

            entity.ToTable("ct_location_id_formats", "cts");

            entity.HasIndex(e => e.TransId, "ct_location_id_formats_trans_id_idx");
        ...
        {
            entity.HasKey(e => e.LidId).HasName("ct_location_identifiers_pkey");

            entity.ToTable("ct_location_identifiers", "cts");

            entity.HasIndex(e => e.LidLocId, "ct_location_identifiers_lid_loc_id_idx");

            entity.HasIndex(e => e.TransId, "ct_location_identifiers_trans_id_idx");

            entity.HasIndex(e => new { e.LidIdentifier, e.LidCurrentStatus, e.LidEffectiveToDate, e.LidEffectiveFromDate, e.LidId }, "ix_ct_location_identifiers_cph").IsDescending(false, false, false, true, true);
            ...
            entity.HasOne(d => d.LidLoc).WithMany(p => p.CtLocationIdentifiers)
                .HasForeignKey(d => d.LidLocId)
                .HasConstraintName("fk_ct_location_identifiers_lid_loc_id");
        });

        modelBuilder.Entity<CtLocationPartyRel>(entity =>
        {
            entity.HasKey(e => e.LprId).HasName("ct_location_party_rels_pkey");

            entity.ToTable("ct_location_party_rels", "cts");
            ...
            entity.HasIndex(e => e.TransId, "ct_location_party_rels_trans_id_idx");

            entity.HasIndex(e => new { e.LprLocId, e.LprLptId, e.LprCurrentStatus, e.LprEffectiveToDate, e.LprEffectiveFromDate, e.LprId }, "ix_ct_location_party_rels_current_location").IsDescending(false, false, false, false, true, true);
            ...
            entity.HasOne(d => d.LprLoc).WithMany(p => p.CtLocationPartyRels)
                .HasForeignKey(d => d.LprLocId)
                .HasConstraintName("fk_ct_location_party_rels_lpr_loc_id");

            entity.HasOne(d => d.LprLpt).WithMany(p => p.CtLocationPartyRels)
                .HasForeignKey(d => d.LprLptId)
                .HasConstraintName("fk_ct_location_party_rels_lpr_lpt_id");

            entity.HasOne(d => d.LprPar).WithMany(p => p.CtLocationPartyRels)
                .HasForeignKey(d => d.LprParId)
                .HasConstraintName("fk_ct_location_party_rels_lpr_par_id");
        });

        modelBuilder.Entity<CtLocationPartyRelType>(entity =>
        {
            entity.HasKey(e => e.LptId).HasName("ct_location_party_rel_types_pkey");

            entity.ToTable("ct_location_party_rel_types", "cts");

            entity.HasIndex(e => e.TransId, "ct_location_party_rel_types_trans_id_idx");

            entity.HasIndex(e => e.LptCode, "ix_ct_location_party_rel_types_code");
        ...
        {
            entity.HasKey(e => e.LrtId).HasName("ct_location_rel_types_pkey");

            entity.ToTable("ct_location_rel_types", "cts");

            entity.HasIndex(e => e.TransId, "ct_location_rel_types_trans_id_idx");
        ...
        {
            entity.HasKey(e => e.LlrId).HasName("ct_location_relationships_pkey");

            entity.ToTable("ct_location_relationships", "cts");
            ...
            entity.HasIndex(e => e.TransId, "ct_location_relationships_trans_id_idx");
            ...
            entity.HasOne(d => d.LlrLocIdChildNavigation).WithMany(p => p.CtLocationRelationshipLlrLocIdChildNavigations)
                .HasForeignKey(d => d.LlrLocIdChild)
                .HasConstraintName("fk_ct_location_relationships_llr_loc_id_child");

            entity.HasOne(d => d.LlrLocIdParentNavigation).WithMany(p => p.CtLocationRelationshipLlrLocIdParentNavigations)
                .HasForeignKey(d => d.LlrLocIdParent)
                .HasConstraintName("fk_ct_location_relationships_llr_loc_id_parent");

            entity.HasOne(d => d.LlrLrt).WithMany(p => p.CtLocationRelationships)
                .HasForeignKey(d => d.LlrLrtId)
                .HasConstraintName("fk_ct_location_relationships_llr_lrt_id");
        });

        modelBuilder.Entity<CtLocationType>(entity =>
        {
            entity.HasKey(e => e.LtyId).HasName("ct_location_types_pkey");

            entity.ToTable("ct_location_types", "cts");

            entity.HasIndex(e => e.LtyCurrentStatus, "ct_location_types_lty_current_status_idx");

            entity.HasIndex(e => e.LtyLifId, "ct_location_types_lty_lif_id_idx");

            entity.HasIndex(e => e.TransId, "ct_location_types_trans_id_idx");
            ...
            entity.HasOne(d => d.LtyLif).WithMany(p => p.CtLocationTypes)
                .HasForeignKey(d => d.LtyLifId)
                .HasConstraintName("fk_ct_location_types_lty_lif_id");
        });
        ...
        modelBuilder.Entity<CtLocationsFaker>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("ct_locations_faker", "cts");

            entity.HasIndex(e => e.TransId, "ct_locations_faker_trans_id_idx");
        ...
        modelBuilder.Entity<CtLocrestrictionstoanimal>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("ct_locrestrictionstoanimals", "cts");
            ...
            entity.HasIndex(e => e.TransId, "ct_locrestrictionstoanimals_trans_id_idx");
            ...
            entity.HasOne(d => d.LraCom).WithMany()
                .HasForeignKey(d => d.LraComId)
                .HasConstraintName("fk_ct_locrestrictionstoanimals_lra_com_id");

            entity.HasOne(d => d.LraLoc).WithMany()
                .HasForeignKey(d => d.LraLocId)
                .HasConstraintName("fk_ct_locrestrictionstoanimals_lra_loc_id");

            entity.HasOne(d => d.LraRan).WithMany()
                .HasForeignKey(d => d.LraRanId)
                .HasConstraintName("fk_ct_locrestrictionstoanimals_lra_ran_id");
        });

        modelBuilder.Entity<CtMgtControlError>(entity =>
        {
            entity.HasKey(e => e.MceId).HasName("ct_mgt_control_errors_pkey");

            entity.ToTable("ct_mgt_control_errors", "cts");

            entity.HasIndex(e => e.MceRanId, "ct_mgt_control_errors_mce_ran_id_idx");

            entity.HasIndex(e => e.TransId, "ct_mgt_control_errors_trans_id_idx");
            ...
            entity.HasOne(d => d.MceRan).WithMany(p => p.CtMgtControlErrors)
                .HasForeignKey(d => d.MceRanId)
                .HasConstraintName("fk_ct_mgt_control_errors_mce_ran_id");
        });

        modelBuilder.Entity<CtMgtWgAllocationRule>(entity =>
        {
            entity.HasKey(e => e.WarId).HasName("ct_mgt_wg_allocation_rules_pkey");

            entity.ToTable("ct_mgt_wg_allocation_rules", "cts");

            entity.HasIndex(e => e.TransId, "ct_mgt_wg_allocation_rules_trans_id_idx");
            ...
            entity.HasOne(d => d.WarRou).WithMany(p => p.CtMgtWgAllocationRules)
                .HasForeignKey(d => d.WarRouId)
                .HasConstraintName("fk_ct_mgt_wg_allocation_rules_war_rou_id");
        });
        ...
        modelBuilder.Entity<CtMhsToCph>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("ct_mhs_to_cph", "cts");

            entity.HasIndex(e => e.TransId, "ct_mhs_to_cph_trans_id_idx");
        ...
        modelBuilder.Entity<CtMovHst>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("ct_mov_hst", "cts");

            entity.HasIndex(e => e.TransId, "ct_mov_hst_trans_id_idx");
        ...
        {
            entity.HasKey(e => e.MseId).HasName("ct_movt_corr_summ_errors_pkey");

            entity.ToTable("ct_movt_corr_summ_errors", "cts");

            entity.HasIndex(e => e.MseMcsId, "ct_movt_corr_summ_errors_mse_mcs_id_idx");

            entity.HasIndex(e => e.TransId, "ct_movt_corr_summ_errors_trans_id_idx");
            ...
            entity.HasOne(d => d.MseMcs).WithMany(p => p.CtMovtCorrSummErrors)
                .HasForeignKey(d => d.MseMcsId)
                .HasConstraintName("fk_ct_movt_corr_summ_errors_mse_mcs_id");
        });

        modelBuilder.Entity<CtMovtCorrectSummary>(entity =>
        {
            entity.HasKey(e => e.McsId).HasName("ct_movt_correct_summaries_pkey");

            entity.ToTable("ct_movt_correct_summaries", "cts");
            ...
            entity.HasIndex(e => e.TransId, "ct_movt_correct_summaries_trans_id_idx");
            ...
            entity.HasOne(d => d.McsMov).WithMany(p => p.CtMovtCorrectSummaries)
                .HasForeignKey(d => d.McsMovId)
                .HasConstraintName("fk_ct_movt_correct_summaries_mcs_mov_id");

            entity.HasOne(d => d.McsRmo).WithMany(p => p.CtMovtCorrectSummaries)
                .HasForeignKey(d => d.McsRmoId)
                .HasConstraintName("fk_ct_movt_correct_summaries_mcs_rmo_id");

            entity.HasOne(d => d.McsSmo).WithMany(p => p.CtMovtCorrectSummaries)
                .HasForeignKey(d => d.McsSmoId)
                .HasConstraintName("fk_ct_movt_correct_summaries_mcs_smo_id");
        });
        ...
        modelBuilder.Entity<CtMsgtxt>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("ct_msgtxt", "cts");

            entity.HasIndex(e => e.TransId, "ct_msgtxt_trans_id_idx");
        ...
        {
            entity.HasKey(e => e.NwdId).HasName("ct_non_working_days_pkey");

            entity.ToTable("ct_non_working_days", "cts");

            entity.HasIndex(e => e.TransId, "ct_non_working_days_trans_id_idx");
        ...
        {
            entity.HasKey(e => e.PgpId).HasName("ct_param_group_pkey");

            entity.ToTable("ct_param_group", "cts");

            entity.HasIndex(e => e.PgpCurrentStatus, "ct_param_group_pgp_current_status_idx");

            entity.HasIndex(e => new { e.PgpParam, e.PgpGroupValue }, "ct_param_group_pgp_param_group_value_idx");

            entity.HasIndex(e => e.PgpParam, "ct_param_group_pgp_param_idx");

            entity.HasIndex(e => e.PgpPhdId, "ct_param_group_pgp_phd_id_idx");

            entity.HasIndex(e => e.TransId, "ct_param_group_trans_id_idx");
            ...
            entity.HasOne(d => d.PgpPhd).WithMany(p => p.CtParamGroups)
                .HasForeignKey(d => d.PgpPhdId)
                .HasConstraintName("fk_ct_param_group_pgp_phd_id");
        });

        modelBuilder.Entity<CtParamHeader>(entity =>
        {
            entity.HasKey(e => e.PhdId).HasName("ct_param_header_pkey");

            entity.ToTable("ct_param_header", "cts");

            entity.HasIndex(e => e.PhdCurrentStatus, "ct_param_header_phd_current_status_idx");

            entity.HasIndex(e => e.TransId, "ct_param_header_trans_id_idx");
        ...
        {
            entity.HasKey(e => e.PvlId).HasName("ct_param_value_pkey");

            entity.ToTable("ct_param_value", "cts");

            entity.HasIndex(e => e.PvlCurrentStatus, "ct_param_value_pvl_current_status_idx");

            entity.HasIndex(e => e.PvlParam, "ct_param_value_pvl_param_idx");

            entity.HasIndex(e => e.PvlPhdId, "ct_param_value_pvl_phd_id_idx");

            entity.HasIndex(e => e.TransId, "ct_param_value_trans_id_idx");

            entity.HasIndex(e => new { e.PvlParam, e.PvlParamValue }, "ix_ct_param_value_lookup");
            ...
            entity.HasOne(d => d.PvlPhd).WithMany(p => p.CtParamValues)
                .HasForeignKey(d => d.PvlPhdId)
                .HasConstraintName("fk_ct_param_value_pvl_phd_id");
        });

        modelBuilder.Entity<CtParamValueGroup>(entity =>
        {
            entity.HasKey(e => e.PvgId).HasName("ct_param_value_group_pkey");

            entity.ToTable("ct_param_value_group", "cts");

            entity.HasIndex(e => e.PvgCurrentStatus, "ct_param_value_group_pvg_current_status_idx");

            entity.HasIndex(e => e.PvgParam, "ct_param_value_group_pvg_param_idx");

            entity.HasIndex(e => new { e.PvgParam, e.PvgParamValue, e.PvgGroupValue }, "ct_param_value_group_pvg_param_value_group_idx");
            ...
            entity.HasIndex(e => e.TransId, "ct_param_value_group_trans_id_idx");
            ...
            entity.HasOne(d => d.PvgPgp).WithMany(p => p.CtParamValueGroups)
                .HasForeignKey(d => d.PvgPgpId)
                .HasConstraintName("fk_ct_param_value_group_pvg_pgp_id");

            entity.HasOne(d => d.PvgPvl).WithMany(p => p.CtParamValueGroups)
                .HasForeignKey(d => d.PvgPvlId)
                .HasConstraintName("fk_ct_param_value_group_pvg_pvl_id");
        });
        ...
        modelBuilder.Entity<CtPartiesFaker>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("ct_parties_faker", "cts");

            entity.HasIndex(e => e.TransId, "ct_parties_faker_trans_id_idx");
        ...
        {
            entity.HasKey(e => e.ParId).HasName("ct_parties_pkey");

            entity.ToTable("ct_parties", "cts");

            entity.HasIndex(e => e.TransId, "ct_parties_trans_id_idx");
        ...
        {
            entity.HasKey(e => e.PpgId).HasName("ct_ppaf_groupings_pkey");

            entity.ToTable("ct_ppaf_groupings", "cts");
            ...
            entity.HasIndex(e => e.TransId, "ct_ppaf_groupings_trans_id_idx");
            ...
            entity.HasOne(d => d.PpgLocIdBirthNavigation).WithMany(p => p.CtPpafGroupingPpgLocIdBirthNavigations)
                .HasForeignKey(d => d.PpgLocIdBirth)
                .HasConstraintName("fk_ct_ppaf_groupings_ppg_loc_id_birth");

            entity.HasOne(d => d.PpgLocIdCorresNavigation).WithMany(p => p.CtPpafGroupingPpgLocIdCorresNavigations)
                .HasForeignKey(d => d.PpgLocIdCorres)
                .HasConstraintName("fk_ct_ppaf_groupings_ppg_loc_id_corres");
        });

        modelBuilder.Entity<CtPreprintedAppnForm>(entity =>
        {
            entity.HasKey(e => e.PafId).HasName("ct_preprinted_appn_forms_pkey");

            entity.ToTable("ct_preprinted_appn_forms", "cts");
            ...
            entity.HasIndex(e => e.TransId, "ct_preprinted_appn_forms_trans_id_idx");
            ...
            entity.HasOne(d => d.PafEtg).WithMany(p => p.CtPreprintedAppnForms)
                .HasForeignKey(d => d.PafEtgId)
                .HasConstraintName("fk_ct_preprinted_appn_forms_paf_etg_id");

            entity.HasOne(d => d.PafPpg).WithMany(p => p.CtPreprintedAppnForms)
                .HasForeignKey(d => d.PafPpgId)
                .HasConstraintName("fk_ct_preprinted_appn_forms_paf_ppg_id");
        });

        modelBuilder.Entity<CtProbityCheck>(entity =>
        {
            entity.HasKey(e => e.PchId).HasName("ct_probity_checks_pkey");

            entity.ToTable("ct_probity_checks", "cts");

            entity.HasIndex(e => e.TransId, "ct_probity_checks_trans_id_idx");
        ...
        {
            entity.HasKey(e => e.RanId).HasName("ct_ps9999_ahdb_data_pkey");

            entity.ToTable("ct_ps9999_ahdb_data", "cts");

            entity.HasIndex(e => e.TransId, "ct_ps9999_ahdb_data_trans_id_idx");
        ...
        modelBuilder.Entity<CtPs9999AhdbMovHistory>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("ct_ps9999_ahdb_mov_history", "cts");

            entity.HasIndex(e => e.TransId, "ct_ps9999_ahdb_mov_history_trans_id_idx");
        ...
        {
            entity.HasKey(e => e.RaeId).HasName("ct_recd_application_errors_pkey");

            entity.ToTable("ct_recd_application_errors", "cts");

            entity.HasIndex(e => e.RaeRapId, "ct_recd_application_errors_rae_rap_id_idx");

            entity.HasIndex(e => e.TransId, "ct_recd_application_errors_trans_id_idx");
            ...
            entity.HasOne(d => d.RaeRap).WithMany(p => p.CtRecdApplicationErrors)
                .HasForeignKey(d => d.RaeRapId)
                .HasConstraintName("fk_ct_recd_application_errors_rae_rap_id");
        });

        modelBuilder.Entity<CtRecdMovementError>(entity =>
        {
            entity.HasKey(e => e.RmeId).HasName("ct_recd_movement_errors_pkey");

            entity.ToTable("ct_recd_movement_errors", "cts");

            entity.HasIndex(e => e.RmeRmoId, "ct_recd_movement_errors_rme_rmo_id_idx");

            entity.HasIndex(e => e.TransId, "ct_recd_movement_errors_trans_id_idx");
            ...
            entity.HasOne(d => d.RmeRmo).WithMany(p => p.CtRecdMovementErrors)
                .HasForeignKey(d => d.RmeRmoId)
                .HasConstraintName("fk_ct_recd_movement_errors_rme_rmo_id");
        });

        modelBuilder.Entity<CtReceivedApplication>(entity =>
        {
            entity.HasKey(e => e.RapId).HasName("ct_received_applications_pkey");

            entity.ToTable("ct_received_applications", "cts");
            ...
            entity.HasIndex(e => e.TransId, "ct_received_applications_trans_id_idx");
            ...
            entity.HasOne(d => d.RapRanIdReservedNavigation).WithMany(p => p.CtReceivedApplications)
                .HasForeignKey(d => d.RapRanIdReserved)
                .HasConstraintName("fk_ct_received_applications_rap_ran_id_reserved");

            entity.HasOne(d => d.RapWgp).WithMany(p => p.CtReceivedApplications)
                .HasForeignKey(d => d.RapWgpId)
                .HasConstraintName("fk_ct_received_applications_rap_wgp_id");
        });

        modelBuilder.Entity<CtReceivedMovement>(entity =>
        {
            entity.HasKey(e => e.RmoId).HasName("ct_received_movements_pkey");

            entity.ToTable("ct_received_movements", "cts");

            entity.HasIndex(e => e.TransId, "ct_received_movements_trans_id_idx");
        ...
        {
            entity.HasKey(e => e.RanId).HasName("ct_registered_animals_pkey");

            entity.ToTable("ct_registered_animals", "cts");
            ...
            entity.HasIndex(e => e.RanCurrentStatus, "ct_registered_animals_ran_current_status_idx");
            ...
            entity.HasIndex(e => e.TransId, "ct_registered_animals_trans_id_idx");
            ...
            entity.HasOne(d => d.RanBrd).WithMany(p => p.CtRegisteredAnimals)
                .HasForeignKey(d => d.RanBrdId)
                .HasConstraintName("ct_registered_animals_ran_brd_id_fkey");

            entity.HasOne(d => d.RanCryIdChrOriginNavigation).WithMany(p => p.CtRegisteredAnimals)
                .HasForeignKey(d => d.RanCryIdChrOrigin)
                .HasConstraintName("ct_registered_animals_ran_cry_id_chr_origin_fkey");

            entity.HasOne(d => d.RanLocIdPassportNavigation).WithMany(p => p.CtRegisteredAnimals)
                .HasForeignKey(d => d.RanLocIdPassport)
                .HasConstraintName("ct_registered_animals_ran_loc_id_passport_fkey");

            entity.HasOne(d => d.RanVap).WithMany(p => p.CtRegisteredAnimals)
                .HasForeignKey(d => d.RanVapId)
                .HasConstraintName("ct_registered_animals_ran_vap_id_fkey");
        });

        modelBuilder.Entity<CtRegisteredMovement>(entity =>
        {
            entity.HasKey(e => e.MovId).HasName("ct_registered_movements_pkey");

            entity.ToTable("ct_registered_movements", "cts");

            entity.HasIndex(e => e.MovAnomalyCode, "ct_registered_movements_mov_anomaly_code_idx");

            entity.HasIndex(e => e.MovCryIdImport, "ct_registered_movements_mov_cry_id_import_idx");

            entity.HasIndex(e => e.MovCurrentStatus, "ct_registered_movements_mov_current_status_idx");

            entity.HasIndex(e => new { e.MovLocId, e.MovAnomalyCode }, "ct_registered_movements_mov_loc_id_anomaly_code_idx");

            entity.HasIndex(e => e.MovLocId, "ct_registered_movements_mov_loc_id_idx");

            entity.HasIndex(e => new { e.MovLocId, e.MovMovementType }, "ct_registered_movements_mov_loc_id_movement_type_idx");

            entity.HasIndex(e => new { e.MovLocId, e.MovCurrentStatus, e.MovMovementDate }, "ct_registered_movements_mov_loc_id_status_date_idx").IsDescending(false, false, true);

            entity.HasIndex(e => e.MovMovementType, "ct_registered_movements_mov_movement_type_idx");

            entity.HasIndex(e => e.MovRanId, "ct_registered_movements_mov_ran_id_idx");

            entity.HasIndex(e => e.TransId, "ct_registered_movements_trans_id_idx");

            entity.HasIndex(e => new { e.MovRanId, e.MovMovementDate, e.MovVersionCreationDate, e.MovId }, "ix_ct_registered_movements_animal_latest")
                .IsDescending(false, true, true, true)
                .HasFilter("(((mov_current_status)::text <> 'C'::text) AND (mov_ran_id IS NOT NULL))")
                .HasNullSortOrder(new[] { NullSortOrder.NullsLast, NullSortOrder.NullsLast, NullSortOrder.NullsLast, NullSortOrder.NullsFirst });

            entity.HasIndex(e => new { e.MovLocId, e.MovDirection, e.MovRanId }, "ix_ct_registered_movements_location").HasFilter("(((mov_current_status)::text <> 'C'::text) AND (mov_ran_id IS NOT NULL) AND (mov_loc_id IS NOT NULL))");
            ...
            entity.HasOne(d => d.MovCryIdImportNavigation).WithMany(p => p.CtRegisteredMovements)
                .HasForeignKey(d => d.MovCryIdImport)
                .HasConstraintName("fk_ct_registered_movements_mov_cry_id_import");

            entity.HasOne(d => d.MovLoc).WithMany(p => p.CtRegisteredMovements)
                .HasForeignKey(d => d.MovLocId)
                .HasConstraintName("fk_ct_registered_movements_mov_loc_id");

            entity.HasOne(d => d.MovRan).WithMany(p => p.CtRegisteredMovements)
                .HasForeignKey(d => d.MovRanId)
                .HasConstraintName("fk_ct_registered_movements_mov_ran_id");
        });

        modelBuilder.Entity<CtResetToExtract>(entity =>
        {
            entity.HasKey(e => e.RteId).HasName("ct_reset_to_extract_pkey");

            entity.ToTable("ct_reset_to_extract", "cts");

            entity.HasIndex(e => e.TransId, "ct_reset_to_extract_trans_id_idx");
        ...
        modelBuilder.Entity<CtSbcsExt>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("ct_sbcs_ext", "cts");

            entity.HasIndex(e => e.TransId, "ct_sbcs_ext_trans_id_idx");
        ...
        {
            entity.HasKey(e => e.SchId).HasName("ct_schemes_pkey");

            entity.ToTable("ct_schemes", "cts");

            entity.HasIndex(e => e.SchCurrentStatus, "ct_schemes_sch_current_status_idx");

            entity.HasIndex(e => e.TransId, "ct_schemes_trans_id_idx");
        ...
        {
            entity.HasKey(e => e.StfId).HasName("ct_stage_files_pkey");

            entity.ToTable("ct_stage_files", "cts");

            entity.HasIndex(e => e.TransId, "ct_stage_files_trans_id_idx");
        ...
        modelBuilder.Entity<CtStageLock>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("ct_stage_locks", "cts");

            entity.HasIndex(e => e.TransId, "ct_stage_locks_trans_id_idx");
        ...
        modelBuilder.Entity<CtStageMessage>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("ct_stage_messages", "cts");

            entity.HasIndex(e => e.TransId, "ct_stage_messages_trans_id_idx");
        ...
        {
            entity.HasKey(e => e.SltId).HasName("ct_sublocation_types_pkey");

            entity.ToTable("ct_sublocation_types", "cts");

            entity.HasIndex(e => e.TransId, "ct_sublocation_types_trans_id_idx");
        ...
        {
            entity.HasKey(e => e.SaeId).HasName("ct_susp_animal_errors_pkey");

            entity.ToTable("ct_susp_animal_errors", "cts");

            entity.HasIndex(e => e.SaeSanId, "ct_susp_animal_errors_sae_san_id_idx");

            entity.HasIndex(e => e.TransId, "ct_susp_animal_errors_trans_id_idx");
            ...
            entity.HasOne(d => d.SaeSan).WithMany(p => p.CtSuspAnimalErrors)
                .HasForeignKey(d => d.SaeSanId)
                .HasConstraintName("fk_ct_susp_animal_errors_sae_san_id");
        });

        modelBuilder.Entity<CtSuspCmMeasureResult>(entity =>
        {
            entity.HasKey(e => e.SmrId).HasName("ct_susp_cm_measure_results_pkey");

            entity.ToTable("ct_susp_cm_measure_results", "cts");

            entity.HasIndex(e => e.SmrScmId, "ct_susp_cm_measure_results_smr_scm_id_idx");

            entity.HasIndex(e => e.TransId, "ct_susp_cm_measure_results_trans_id_idx");
            ...
            entity.HasOne(d => d.SmrScm).WithMany(p => p.CtSuspCmMeasureResults)
                .HasForeignKey(d => d.SmrScmId)
                .HasConstraintName("fk_ct_susp_cm_measure_results_smr_scm_id");
        });

        modelBuilder.Entity<CtSuspConditionMarker>(entity =>
        {
            entity.HasKey(e => e.ScmId).HasName("ct_susp_condition_markers_pkey");

            entity.ToTable("ct_susp_condition_markers", "cts");
            ...
            entity.HasIndex(e => e.TransId, "ct_susp_condition_markers_trans_id_idx");
            ...
            entity.HasOne(d => d.ScmLoc).WithMany(p => p.CtSuspConditionMarkers)
                .HasForeignKey(d => d.ScmLocId)
                .HasConstraintName("fk_ct_susp_condition_markers_scm_loc_id");

            entity.HasOne(d => d.ScmRan).WithMany(p => p.CtSuspConditionMarkers)
                .HasForeignKey(d => d.ScmRanId)
                .HasConstraintName("fk_ct_susp_condition_markers_scm_ran_id");
        });

        modelBuilder.Entity<CtSuspMovementError>(entity =>
        {
            entity.HasKey(e => e.SmeId).HasName("ct_susp_movement_errors_pkey");

            entity.ToTable("ct_susp_movement_errors", "cts");

            entity.HasIndex(e => e.SmeSmoId, "ct_susp_movement_errors_sme_smo_id_idx");

            entity.HasIndex(e => e.TransId, "ct_susp_movement_errors_trans_id_idx");
            ...
            entity.HasOne(d => d.SmeSmo).WithMany(p => p.CtSuspMovementErrors)
                .HasForeignKey(d => d.SmeSmoId)
                .HasConstraintName("fk_ct_susp_movement_errors_sme_smo_id");
        });

        modelBuilder.Entity<CtSuspendedAnimal>(entity =>
        {
            entity.HasKey(e => e.SanId).HasName("ct_suspended_animals_pkey");

            entity.ToTable("ct_suspended_animals", "cts");
            ...
            entity.HasIndex(e => e.TransId, "ct_suspended_animals_trans_id_idx");
            ...
            entity.HasOne(d => d.SanLocIdInitialNavigation).WithMany(p => p.CtSuspendedAnimalSanLocIdInitialNavigations)
                .HasForeignKey(d => d.SanLocIdInitial)
                .HasConstraintName("fk_ct_suspended_animals_san_loc_id_initial");

            entity.HasOne(d => d.SanLocIdRequestNavigation).WithMany(p => p.CtSuspendedAnimalSanLocIdRequestNavigations)
                .HasForeignKey(d => d.SanLocIdRequest)
                .HasConstraintName("fk_ct_suspended_animals_san_loc_id_request");

            entity.HasOne(d => d.SanRan).WithMany(p => p.CtSuspendedAnimals)
                .HasForeignKey(d => d.SanRanId)
                .HasConstraintName("fk_ct_suspended_animals_san_ran_id");

            entity.HasOne(d => d.SanVap).WithMany(p => p.CtSuspendedAnimals)
                .HasForeignKey(d => d.SanVapId)
                .HasConstraintName("fk_ct_suspended_animals_san_vap_id");

            entity.HasOne(d => d.SanWgp).WithMany(p => p.CtSuspendedAnimals)
                .HasForeignKey(d => d.SanWgpId)
                .HasConstraintName("fk_ct_suspended_animals_san_wgp_id");
        });

        modelBuilder.Entity<CtSuspendedMovement>(entity =>
        {
            entity.HasKey(e => e.SmoId).HasName("ct_suspended_movements_pkey");

            entity.ToTable("ct_suspended_movements", "cts");

            entity.HasIndex(e => e.TransId, "ct_suspended_movements_trans_id_idx");
        ...
        {
            entity.HasKey(e => e.ScaId).HasName("ct_suspense_char_alloc_rules_pkey");

            entity.ToTable("ct_suspense_char_alloc_rules", "cts");

            entity.HasIndex(e => e.ScaRouId, "ct_suspense_char_alloc_rules_sca_rou_id_idx");

            entity.HasIndex(e => e.TransId, "ct_suspense_char_alloc_rules_trans_id_idx");
            ...
            entity.HasOne(d => d.ScaRou).WithMany(p => p.CtSuspenseCharAllocRules)
                .HasForeignKey(d => d.ScaRouId)
                .HasConstraintName("fk_ct_suspense_char_alloc_rules_sca_rou_id");
        });

        modelBuilder.Entity<CtSuspenseWgAllocRule>(entity =>
        {
            entity.HasKey(e => e.SwaId).HasName("ct_suspense_wg_alloc_rules_pkey");

            entity.ToTable("ct_suspense_wg_alloc_rules", "cts");

            entity.HasIndex(e => e.SwaRouId, "ct_suspense_wg_alloc_rules_swa_rou_id_idx");

            entity.HasIndex(e => e.TransId, "ct_suspense_wg_alloc_rules_trans_id_idx");
            ...
            entity.HasOne(d => d.SwaRou).WithMany(p => p.CtSuspenseWgAllocRules)
                .HasForeignKey(d => d.SwaRouId)
                .HasConstraintName("fk_ct_suspense_wg_alloc_rules_swa_rou_id");
        });

        modelBuilder.Entity<CtValidApplication>(entity =>
        {
            entity.HasKey(e => e.VapId).HasName("ct_valid_applications_pkey");

            entity.ToTable("ct_valid_applications", "cts");

            entity.HasIndex(e => e.TransId, "ct_valid_applications_trans_id_idx");
            ...
            entity.HasOne(d => d.VapLocIdRequesterNavigation).WithMany(p => p.CtValidApplications)
                .HasForeignKey(d => d.VapLocIdRequester)
                .HasConstraintName("fk_ct_valid_applications_vap_loc_id_requester");

            entity.HasOne(d => d.VapWur).WithMany(p => p.CtValidApplications)
                .HasForeignKey(d => d.VapWurId)
                .HasConstraintName("fk_ct_valid_applications_vap_wur_id");
        });

        modelBuilder.Entity<CtWebUser>(entity =>
        {
            entity.HasKey(e => e.WurId).HasName("ct_web_users_pkey");

            entity.ToTable("ct_web_users", "cts");

            entity.HasIndex(e => e.TransId, "ct_web_users_trans_id_idx");
            ...
            entity.HasOne(d => d.WurLprIdKeeperNavigation).WithMany(p => p.CtWebUsers)
                .HasForeignKey(d => d.WurLprIdKeeper)
                .HasConstraintName("fk_ct_web_users_wur_lpr_id_keeper");
        });

        modelBuilder.Entity<CtWgAutoallocation>(entity =>
        {
            entity.HasKey(e => e.WgaId).HasName("ct_wg_autoallocations_pkey");

            entity.ToTable("ct_wg_autoallocations", "cts");

            entity.HasIndex(e => e.TransId, "ct_wg_autoallocations_trans_id_idx");
            ...
            entity.HasOne(d => d.WgaRou).WithMany(p => p.CtWgAutoallocations)
                .HasForeignKey(d => d.WgaRouId)
                .HasConstraintName("fk_ct_wg_autoallocations_wga_rou_id");

            entity.HasOne(d => d.WgaWgp).WithMany(p => p.CtWgAutoallocations)
                .HasForeignKey(d => d.WgaWgpId)
                .HasConstraintName("fk_ct_wg_autoallocations_wga_wgp_id");
        });

        modelBuilder.Entity<CtWgSuperAssignment>(entity =>
        {
            entity.HasKey(e => e.WsaId).HasName("ct_wg_super_assignments_pkey");

            entity.ToTable("ct_wg_super_assignments", "cts");

            entity.HasIndex(e => e.TransId, "ct_wg_super_assignments_trans_id_idx");
            ...
            entity.HasOne(d => d.WsaRou).WithMany(p => p.CtWgSuperAssignments)
                .HasForeignKey(d => d.WsaRouId)
                .HasConstraintName("fk_ct_wg_super_assignments_wsa_rou_id");

            entity.HasOne(d => d.WsaWgpIdAssignedNavigation).WithMany(p => p.CtWgSuperAssignmentWsaWgpIdAssignedNavigations)
                .HasForeignKey(d => d.WsaWgpIdAssigned)
                .HasConstraintName("fk_ct_wg_super_assignments_wsa_wgp_id_assigned");

            entity.HasOne(d => d.WsaWgpIdCurrentNavigation).WithMany(p => p.CtWgSuperAssignmentWsaWgpIdCurrentNavigations)
                .HasForeignKey(d => d.WsaWgpIdCurrent)
                .HasConstraintName("fk_ct_wg_super_assignments_wsa_wgp_id_current");
        });

        modelBuilder.Entity<CtWgUserAssignment>(entity =>
        {
            entity.HasKey(e => e.WuaId).HasName("ct_wg_user_assignments_pkey");

            entity.ToTable("ct_wg_user_assignments", "cts");

            entity.HasIndex(e => e.TransId, "ct_wg_user_assignments_trans_id_idx");
            ...
            entity.HasOne(d => d.WuaCus).WithMany(p => p.CtWgUserAssignments)
                .HasForeignKey(d => d.WuaCusId)
                .HasConstraintName("fk_ct_wg_user_assignments_wua_cus_id");

            entity.HasOne(d => d.WuaWgp).WithMany(p => p.CtWgUserAssignments)
                .HasForeignKey(d => d.WuaWgpId)
                .HasConstraintName("fk_ct_wg_user_assignments_wua_wgp_id");
        });

        modelBuilder.Entity<CtWorkgroup>(entity =>
        {
            entity.HasKey(e => e.WgpId).HasName("ct_workgroups_pkey");

            entity.ToTable("ct_workgroups", "cts");

            entity.HasIndex(e => e.TransId, "ct_workgroups_trans_id_idx");
