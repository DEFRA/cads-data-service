...
public partial class CtLocationPartyRel
{
    ...
    public virtual ICollection<CtWebUser> CtWebUsers { get; set; } = new List<CtWebUser>();

    public virtual CtLocation? LprLoc { get; set; }

    public virtual CtLocationPartyRelType? LprLpt { get; set; }

    public virtual CtParty? LprPar { get; set; }
}
