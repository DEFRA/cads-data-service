...
public partial class CtRegisteredMovement1
{
    ...
    public long? MovAudId { get; set; }

    public string? MovAudType { get; set; }

    public DateTime? MovAudDatetime { get; set; }
    ...
    public virtual ICollection<CtRegisteredMovement2> CtRegisteredMovement2s { get; set; } = new List<CtRegisteredMovement2>();
