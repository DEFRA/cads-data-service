...
public partial class CtConditionVariant
{
    ...
    public virtual CtCondition? CovCon { get; set; }

    public virtual ICollection<CtCondVariantGrouping> CtCondVariantGroupings { get; set; } = new List<CtCondVariantGrouping>();
