...
public partial class CtReceivedApplication
{
    ...
    public virtual ICollection<CtRecdApplicationError> CtRecdApplicationErrors { get; set; } = new List<CtRecdApplicationError>();

    public virtual CtRegisteredAnimal? RapRanIdReservedNavigation { get; set; }

    public virtual CtWorkgroup? RapWgp { get; set; }
}
