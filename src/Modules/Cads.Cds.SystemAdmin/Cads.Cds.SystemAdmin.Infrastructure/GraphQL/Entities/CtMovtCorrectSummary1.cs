...
public partial class CtMovtCorrectSummary1
{
    ...
    public long? McsAudId { get; set; }

    public string? McsAudType { get; set; }

    public DateTime? McsAudDatetime { get; set; }
    ...
    public virtual ICollection<CtMovtCorrectSummary2> CtMovtCorrectSummary2s { get; set; } = new List<CtMovtCorrectSummary2>();
