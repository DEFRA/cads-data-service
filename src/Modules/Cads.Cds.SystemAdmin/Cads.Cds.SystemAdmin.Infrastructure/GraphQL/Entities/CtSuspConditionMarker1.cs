...
public partial class CtSuspConditionMarker1
{
    ...
    public long? ScmAudId { get; set; }

    public string? ScmAudType { get; set; }

    public DateTime? ScmAudDatetime { get; set; }
    ...
    public virtual ICollection<CtSuspConditionMarker2> CtSuspConditionMarker2s { get; set; } = new List<CtSuspConditionMarker2>();
