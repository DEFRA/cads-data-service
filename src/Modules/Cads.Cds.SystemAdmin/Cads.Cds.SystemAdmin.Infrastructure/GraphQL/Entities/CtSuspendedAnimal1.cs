...
public partial class CtSuspendedAnimal1
{
    ...
    public long? SanAudId { get; set; }

    public string? SanAudType { get; set; }

    public DateTime? SanAudDatetime { get; set; }
    ...
    public virtual ICollection<CtSuspendedAnimal2> CtSuspendedAnimal2s { get; set; } = new List<CtSuspendedAnimal2>();
