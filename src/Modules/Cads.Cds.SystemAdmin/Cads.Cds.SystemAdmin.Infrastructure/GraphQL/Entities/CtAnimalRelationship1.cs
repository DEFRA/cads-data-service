...
public partial class CtAnimalRelationship1
{
    ...
    public long? AarAudId { get; set; }

    public string? AarAudType { get; set; }

    public DateTime? AarAudDatetime { get; set; }
    ...
    public virtual ICollection<CtAnimalRelationship2> CtAnimalRelationship2s { get; set; } = new List<CtAnimalRelationship2>();
