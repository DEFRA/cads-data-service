...
public class CtLocationUpdateScenario(
    CtsTransactionsSystemAdminDbContext dbContext,
    IFileNameGenerator fileNameGenerator,
    IFileAssembler fileAssembler,
    ILogger<CtLocationUpdateScenario> logger)
    : GenerationScenario<CtLocation>("ct_location_update_scenario", ImportActionType.Delta, dbContext, fileNameGenerator, fileAssembler, logger)
{
