...
public class AnnualInventoryService(
    IWebHostEnvironment env,
    IFileService fileService,
    IOptions<MiBffModuleConfiguration> options) : Amsl2SampleDataService<Amsl2Dto>(env, fileService, options), IAnnualInventoryService
{
}