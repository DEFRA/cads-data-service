...
public class AnimalSummaryService(
    ...
    IOptions<MiBffModuleConfiguration> options) : Amsl2SampleDataService<Amsl2Dto>(env, fileService, options), IAnimalSummaryService
{
    public async Task<IEnumerable<Amsl2Dto>> GetByAnimalIdAsync(Guid animalId, CancellationToken cancellationToken = default)
    {
