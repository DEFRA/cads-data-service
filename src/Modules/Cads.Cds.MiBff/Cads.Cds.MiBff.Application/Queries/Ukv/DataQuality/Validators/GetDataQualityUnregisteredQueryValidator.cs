...
namespace Cads.Cds.MiBff.Application.Queries.Ukv.DataQuality.Validators;

public class GetDataQualityUnregisteredQueryValidator : AbstractValidator<GetDataQualityUnregisteredQuery>
{
